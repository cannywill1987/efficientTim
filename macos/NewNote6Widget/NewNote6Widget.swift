...
struct Provider: TimelineProvider {
    @AppStorage("WQBMissionStoreDataNote6", store: UserDefaults(suiteName: "S4CLCWPCGH.com.timespeed.timehello")) var primaryData : Data = Data()
...
struct NewNote6WidgetEntryView : View {
...
struct NewNote6Widget: Widget {
    let kind: String = "NewNoteWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            if #available(macOS 14.0, *) {
                NewNote6WidgetEntryView(entry: entry)
