...
struct Provider: TimelineProvider {
    @AppStorage("WQBMissionStoreDataNote3", store: UserDefaults(suiteName: "group.com.timespeed.timehello")) var primaryData : Data = Data()
...
struct Note3WidgetEntryView : View {
...
@main
struct Note3Widget: Widget {
    let kind: String = "NoteWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            Note3WidgetEntryView(entry: entry)
        }
