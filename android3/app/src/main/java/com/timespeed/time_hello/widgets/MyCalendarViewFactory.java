...
class MyCalendarViewFactory implements RemoteViewsService.RemoteViewsFactory {
    private JSONArray mData;
    private Context mContext;
//    int priority = 1;

    public MyCalendarViewFactory(Context context, JSONArray mData) {
        this.mContext = context;
        this.mData = mData;
//        this.priority = priority;
    }

    public MyCalendarViewFactory(Context context) {
        mContext = context;
    }
