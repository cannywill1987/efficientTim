...
public class MyQuadrantWidgetProvider extends AppWidgetProvider {
...
//        AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
        if (AppWidgetManager.ACTION_APPWIDGET_DELETED.equals(action)) {
            ...
            AppWidgetManager.getInstance(context).updateAppWidget(new ComponentName(context, MyQuadrantWidgetProvider.class), Utility.getQuadrantRemoteViews(context));
        }
...
//        appWidgetManager.updateAppWidget(appWidgetIds, remoteViews);//用updateAppWidget来更新remoteViews的状态
    ...
    private void onWidgetUpdate(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        RemoteViews remoteViews = Utility.getQuadrantRemoteViews(context);
