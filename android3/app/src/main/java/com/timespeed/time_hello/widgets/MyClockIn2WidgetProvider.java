...
public class MyClockIn2WidgetProvider extends AppWidgetProvider {
...
//        AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
        if (AppWidgetManager.ACTION_APPWIDGET_DELETED.equals(action)) {
            ...
            AppWidgetManager.getInstance(context).updateAppWidget(new ComponentName(context, MyClockIn2WidgetProvider.class), Utility.getClockInRemoteViews2(context));
        }
