...
public class MyNote5WidgetProvider extends AppWidgetProvider {
...
//        }
            ...
            AppWidgetManager.getInstance(context).updateAppWidget(new ComponentName(context, MyNote5WidgetProvider.class), Utility.getMyNoteView(context, "5"));
        }
...
//        appWidgetManager.updateAppWidget(appWidgetIds, remoteViews);//用updateAppWidget来更新remoteViews的状态
    ...
    private void onWidgetUpdate(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        RemoteViews remoteViews = Utility.getMyNoteView(context, "5");
