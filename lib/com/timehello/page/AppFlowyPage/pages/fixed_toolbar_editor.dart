...
class _FixedToolbarExampleState extends State<FixedToolbarExample> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: editorState,
        builder: (context,AsyncSnapshot<EditorState>  snapshot) {
...
class _FixedToolbar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder(
      ...
      builder: (context, Selection? selection, _) {
          ...
          itemBuilder: (_, index) {
            ...
            return IconButton(
              ...
              onPressed: () {
                ...
                int iconPoint = items[index].codePoint;
                if(iconPoint == Icons.format_bold.codePoint) {
                  editorState.toggleAttribute(AppFlowyRichTextKeys.bold);
                } else if (iconPoint == Icons.format_italic) {
                  editorState.toggleAttribute(AppFlowyRichTextKeys.italic);
                } else if(iconPoint == Icons.format_underlined) {
                  editorState.toggleAttribute(AppFlowyRichTextKeys.underline);
                } else if(iconPoint == Icons.format_strikethrough) {
                  editorState.toggleAttribute(AppFlowyRichTextKeys.strikethrough);
                } else if(iconPoint == Icons.text_fields) {
                  editorState.formatNode(null, (node) {
                    return node.copyWith(
                      type: ParagraphBlockKeys.type,
                    );
                  });
                } else if(iconPoint == Icons.format_list_bulleted) {
                  editorState.formatNode(null, (node) {
                    return node.copyWith(
                ...
                } else if(iconPoint == Icons.format_list_numbered) {
                  editorState.formatNode(null, (node) {
                    return node.copyWith(
                ...
                } else if(iconPoint == Icons.format_align_left) {
                  editorState.formatNode(null, (node) {
                    return node.copyWith(
                      attributes: {
                        ...node.attributes,
                ...
                } else if(iconPoint == Icons.format_align_center) {
                  editorState.formatNode(null, (node) {
                    return node.copyWith(
                      attributes: {
                        ...node.attributes,
                ...
                } else if(iconPoint == Icons.format_align_right) {
                  editorState.formatNode(null, (node) {
                    return node.copyWith(
                      attributes: {
                        ...node.attributes,
                ...
                } else if(iconPoint == Icons.horizontal_rule) {
                ...
                // switch (iconPoint) {
                //   case Icons.format_bold.codePoint:
                //     editorState.toggleAttribute(AppFlowyRichTextKeys.bold);
                //     break;
