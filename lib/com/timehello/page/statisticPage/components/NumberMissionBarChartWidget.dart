...
class NumberMissionBarChartWidget extends StatefulWidget {
  BarModelList? datas;

  NumberMissionBarChartWidget({this.datas});

  @override
  State<StatefulWidget> createState() => NumberMissionBarChartWidgetState(
      xList: datas?.listBarModel?.keys.toList(growable: true) ?? []);
}

class NumberMissionBarChartWidgetState extends State<NumberMissionBarChartWidget> {
  List<String> xList = [];
  ...
  NumberMissionBarChartWidgetState({xList}) {
    this.xList = xList;
  }
  ...
  @override
  void didUpdateWidget(NumberMissionBarChartWidget oldWidget) {
