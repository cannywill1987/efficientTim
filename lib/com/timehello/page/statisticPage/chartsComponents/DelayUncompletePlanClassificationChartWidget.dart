...
class DelayUncompletePlanClassificationChartWidget extends StatefulWidget {
  ...
  DelayUncompletePlanClassificationChartWidget(
      {required this.startDateTime,  this.endDateTime ,
      required this.completePlanStatusEnum,
      this.datasFolderModelWithExtraData});

  @override
  _DelayUncompletePlanClassificationChartWidgetState createState() =>
      _DelayUncompletePlanClassificationChartWidgetState();
}

/// State class the chart with sorting options.
class _DelayUncompletePlanClassificationChartWidgetState
    extends State<DelayUncompletePlanClassificationChartWidget> {
  _DelayUncompletePlanClassificationChartWidgetState();
  ...
  List<ChartSampleData> getChartSampleData() {
    ...
    this
      ...
      list.add(ChartSampleData(
          ...
          size: height,
          y: data.folderTimeModel.numMissionDelayed,
          pointColor: Color(data.folderModel.color == 0
              ? 0xffff8800
    ...
    return <BarSeries<ChartSampleData, String>>[
      BarSeries<ChartSampleData, String>(
        onPointTap: (ChartPointDetails pointInteractionDetails) async {
          ...
          // int pointIndex = pointInteractionDetails.pointIndex ?? 0;
          // FolderModelWithExtraData folderModelWithExtraData =
          //     this.widget.datasFolderModelWithExtraData![pointIndex];
