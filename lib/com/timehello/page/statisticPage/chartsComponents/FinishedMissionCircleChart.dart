...
class FinishedMissionCircleChart extends StatefulWidget {
  /// Creates the doughnut chart with legend
  FinishedMissionCircleChart() : super();

  @override
  _FinishedMissionCircleChartState createState() => _FinishedMissionCircleChartState();
}

class _FinishedMissionCircleChartState extends State<FinishedMissionCircleChart> {
  _FinishedMissionCircleChartState();
  ...
  Widget build(BuildContext context) {
    return _buildFinishedMissionCircleChartChart();
  }

  ///Get the default circular series with legend
  SfCircularChart _buildFinishedMissionCircleChartChart() {
    return SfCircularChart(
      title: ChartTitle(text: true ? '' : 'Electricity sectors'),
      legend: Legend(
          position: _position,
          isVisible: true,
      ...
      series: _getFinishedMissionCircleChartSeries(),
      tooltipBehavior: TooltipBehavior(enable: true),
    );
  }

  ///Get the default circular series
  List<DoughnutSeries<ChartSampleData, String>> _getFinishedMissionCircleChartSeries() {
          ...
          return ListView(shrinkWrap: true, children: <Widget>[
            Row(
              children: <Widget>[
                ...
                Expanded(flex: true ? 7 : 1, child: Container()),
              ],
            ),
          ]);
        });
