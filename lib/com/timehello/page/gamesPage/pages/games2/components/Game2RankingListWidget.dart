...
/**
 *
 * 嵌入在 Game2RankingDialogUtil
 */
class Game2RankingListWidget extends StatefulWidget {
  OnTapListener? onTapListener;
  Game2RankingListWidgetState? gameRankingListWidgetState;
  String gameCode;
  String? gameMode;
  GameRankingBean gameRankingBean;
  Function onRequestComplete;
  Game2RankingListWidget({
    Key? key,
  ...
  State<StatefulWidget> createState() {
    ...
    return gameRankingListWidgetState = new Game2RankingListWidgetState();
  }
}

class Game2RankingListWidgetState extends State<Game2RankingListWidget> {
  int page = 1;
  int pageSize = 10;
    ...
    BaseBean response =
        await HttpManager.getInstance().doPostRequest(Apis.gameRankingGetList,
            params: {
              "page": page,
              "pageSize": pageSize,
              "valRanking": this.widget.gameRankingBean.score,
              "mode": "Order_By_Score",
              ...
              children: [
                ...
                GameRankingNumWidget(
                  val: Utility.getFunnel(
                      numCharsCorrect: bean.val1 ?? 0, numCharsErrors: bean.val2 ?? 0),
