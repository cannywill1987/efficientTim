...
import 'Game2RankingListWidget.dart';

/**
 * game 2定制化的排行榜
 */
class Game2RankingDialogUtil {
            ...
            child: ClipRRect(
                ...
                child: Container(
                    ...
                    constraints: BoxConstraints(
                        maxHeight: this.maxHeight ?? 0, maxWidth: 400),
                    child: Column(
                      ...
                      children: [
                        ...
                        Game2RankingListWidget(
                          ...
                          gameRankingBean: this.widget.gameRankingBean ?? GameRankingBean(),
