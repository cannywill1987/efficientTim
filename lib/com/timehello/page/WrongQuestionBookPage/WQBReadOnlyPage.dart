...
class WQBReadOnlyPage extends BaseWidget {
  ...
  String? ossUrl;
  WQBReadOnlyPage({required this.richTextModeEnum,
  ...
  BaseWidgetState<BaseWidget<ChangeNotifier>> getState() {
    ...
    return _WQBReadOnlyPageState(ossUrl: this.ossUrl);
  }
}

class _WQBReadOnlyPageState extends BaseWidgetState<WQBReadOnlyPage> {
  String? ossUrl;
  ...
  _WQBReadOnlyPageState({this.ossUrl});
  ...
  @override
  void didUpdateWidget(WQBReadOnlyPage oldWidget) {
    if(this.widget.ossUrl != this.ossUrl)
      requestData();
  }
