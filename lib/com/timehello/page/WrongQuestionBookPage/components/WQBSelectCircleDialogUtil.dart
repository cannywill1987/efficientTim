...
import '../../createFolderPage/WQBCreateFolderPage.dart';
 ...
 * 选择文件夹Circle对话框
 */
class WQBSelectCircleDialogUtil {
        ...
        builder: (BuildContext context) {
          // if (dialogContent == null) {
            return DialogContent(
                // key: Keys.WQBSelectCircleDialogUtilStateGlobalKey,
                title: title,
                content: content,
                leftText: leftText,
                rightText: rightText,
...
class DialogContent extends StatefulWidget {
  ...
  @override
  SelectCircleDialogContentState createState() => SelectCircleDialogContentState(
...
class SelectCircleDialogContentState extends State<DialogContent> {
  String? label = '';
   String? title; //标题
   String? content; //内容
   String? leftText; //左边按钮文字
  ...
  SelectCircleDialogContentState(
      {this.onTapCreateTagListener,
      this.onTapListener,
      this.title,
      this.content,
                          ...
                          new ElevatedButton(
                            ...
                            onPressed: () {
                              ...
                              if(this.okCallBack != null) {
                                this.okCallBack!(this._listFolderModel?[this._sheetDataModelCur?.index ?? 0]);
                              }
                            },
                          ),
                        ],
