...
class WQBContainerTitleWidget extends StatefulWidget {
  Icon? icon;
  String title;
  String? subTitle;
  ...
  State<StatefulWidget> createState() {
    ...
    return WQBContainerTitleWidgetState();
  }
}

class WQBContainerTitleWidgetState extends State<WQBContainerTitleWidget> {
  @override
