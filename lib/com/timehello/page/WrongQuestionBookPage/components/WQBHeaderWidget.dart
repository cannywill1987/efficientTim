...
// class WQBHeaderWidget extends StatefulWidget {
//   List _datas = [];
//   OnTapListener? onTapListener;
//   Function? onChangeListener;
//   WQBHeaderWidgetState? menuSilverListState;
...
class HeaderInputState extends State<WQBHeaderWidget> {
  ...
  @override
  void didUpdateWidget(WQBHeaderWidget oldWidget) {
    this.curFolderModel = this.widget.folderModel;
    if(inputController?.text != this.widget.text) {
          ...
          Focus(
              ...
              child: TextField(
                ...
                decoration:  InputDecoration(
                    contentPadding: EdgeInsets.only(left: 60, right: 75, top: 0, bottom: 0),
                    counterStyle:
                    ...
                    // ),
                        prefixIcon: Icon(
                          Icons.title_sharp,
                          color: ThemeManager.getInstance().getIconColor(defaultColor: Color(0xffd5d5d5)),
                        ),
                    // prefixIconColor: Color(0xffd5d5d5),
                    border: _outlineInputBorder,
                        prefixIconColor: Color(0xffd5d5d5),
                        floatingLabelStyle:
                            TextStyle(color: ThemeManager.getInstance().getTextColor(defaultColor: Color(0xffff0000)), fontSize: 14),
                        labelStyle:
                    ...
                    // labelText: getI18NKey().search,
                        ...
                        labelText: getI18NKey().pleaseInputTitle,
                    ),
                // decoration: InputDecoration(
        ...
        child: Column(
          children: <Widget>[
            ...
            Text(
              this.widget.title ?? "",
              style: TextStyle(
                  color: ColorsConfig.gray_a7, fontSize: titleFontSize),
            ),
          ],
