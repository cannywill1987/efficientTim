...
import 'components/WQBMenuSilverList.dart';

class WQBFoldersPage extends BaseWidget {
  // final OnMapCallback onTapListener;
  Function onTapItemListener;
  WQBFoldersPage({required this.onTapItemListener});

  @override
  BaseWidgetState<BaseWidget> getState() {
    return _WQBFoldersPageWidgetState();
  }
}

class _WQBFoldersPageWidgetState<T> extends BaseWidgetState<WQBFoldersPage> {
  List<WQBFolderModel> _folderModelList = [];
  CalendarModel? calendarModel;

  @override
  void onCreate() {
    super.onCreate();
    curPage = "WQBFoldersPage";
  }
    ...
    if (result == OkCancelResult.ok) {
      await Future.wait([
        MongoApisManager.getInstance()
            .delete_WQBFolderModel(currentObjectId: data.folderModelWithExtraData.objectId),
        // MongoApisManager.getInstance()
  ...
  baseBuild(BuildContext context) {
    ...
    _folderModelList = context.read<GlobalStateEnv>().listWQBFolderModel;
  ...
  Widget getMenuList() {
    ...
    return Selector<GlobalStateEnv, List<WQBFolderModel>>(
      selector: (_, globalStateEnv) => globalStateEnv.listWQBFolderModel,
      builder: (_, listWQBMissionModel, __) {
        this._folderModelList = listWQBMissionModel;
