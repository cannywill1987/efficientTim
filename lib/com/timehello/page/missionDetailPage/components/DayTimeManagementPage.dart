...
Function onCreateMissionListener;
  ...
  @override
  DayTimeManagementPageState createState() => DayTimeManagementPageState();
}

class DayTimeManagementPageState extends State<DayTimeManagementPage> {
  DayTimeManagementPageState();
  ...
  Widget build(BuildContext context) {
    ...
    return
            _calendarController.view == CalendarView.month &&
                ...
                : Container(color: ThemeManager.getInstance().getCardBackgroundColor(defaultColor: Colors.white), child: calendar);
  }
  ...
  void onClick(type, data) async {
    switch (type) {
      case 'onClickOpenMissionDetailPage':
        this.onClickOpenMissionDetailPage(data['missionModel']);
        break;
    }
  }
   ...
   * 跳转到设置叶敏
   */
  void onClickOpenMissionDetailPage(MissionModel data) {
    FolderModel? folderModel = TextUtil.isEmpty(data.folder_id) == true
        ? null
  ...
  SfCalendar _getDragAndDropCalendar(
    ...
    return SfCalendar(
      ...
      onLongPress: (CalendarLongPressDetails details) {
        ...
        // } else {
        //   OverlayManagement.getInstance().showPCCustomOverlay(child: CreateMissionPage(
        //       missionModel: missionModel, onRefresh: () {
        //     OverlayManagement.getInstance().hidePCCustomOverlay();
        //   }), context: context);
      ...
      onTap: (CalendarTapDetails details) async {
        ...
        if (appointmentDynamic != null) {
          ...
          if (appointment != null) {
            ...
            this.onClick('onClickOpenMissionDetailPage', {'missionModel': missionModel});
          }
        } else {
          Utility.popupDesktopRightNavigator(context);
        }
