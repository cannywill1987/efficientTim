...
//
// class BakgroundWidget extends StatefulWidget {
//   String sec;
//   String min;
//   int type = 0; //0 -- 晚上 1 -- 白天
//   BakgroundWidget({Key? key, this.type = 0, this.sec = "00", this.min = "00"})
//       : super(key: key);
//
//   @override
...
// }
//
// class BakgroundState extends State<BakgroundWidget>
...
//   AnimationController? controllerShootingStar1Opacity;
//
...
//         vsync: this);
//     animationCloud1 =
//         new Tween(begin: cloud1X, end: cloud1X + 0.6).animate(controllerCloud1!)
//           ..addListener(() {
//             // setState(() {
//             //   // the state that has changed here is the animation object’s value
//             // });
...
//         vsync: this);
//     animationCloud2 =
//         new Tween(begin: cloud2X, end: cloud2X + 0.3).animate(controllerCloud2!)
//           ..addListener(() {
//             // setState(() {
//             //   // the state that has changed here is the animation object’s value
//             // });
...
//         vsync: this);
//     animationCloud3 =
//         new Tween(begin: cloud3X, end: cloud3X + 0.2).animate(controllerCloud3!)
//           ..addListener(() {
//             // setState(() {
//             //   // the state that has changed here is the animation object’s value
//             // });
...
//         reverseDuration: const Duration(milliseconds: 2000),
//         vsync: this);
//     animationShootingStar1 =
//         new Tween(begin: 0.0, end: 0.05).animate(controllerShootingStar1!)
//           ..addListener(() {
//             setState(() {
//               // the state that has changed here is the animation object’s value
//             });
...
//         reverseDuration: const Duration(milliseconds: 2000),
//         vsync: this);
//     controllerShootingStar1Opacity =
//         (new Tween(begin: 0.0, end: 1.0).animate(animationShootingStar1Opacity!)
//           ..addListener(() {
//             setState(() {
//               // the state that has changed here is the animation object’s value
//             });
...
//     // animationTree?.removeListener(null);
//     // animationCloud1?.removeListener(null);
//     // animationCloud2?.removeListener(null);
//     // animationCloud3?.removeListener(null);
//     // animationShootingStar1?.removeListener(null);
//     controllerCloud3 = null;
//     controllerCloud2 = null;
//     controllerCloud1 = null;
//     controllerShootingStar1 = null;
//     controllerTree = null;
//     animationTree = null;
//     animationCloud1 = null;
//     animationCloud2 = null;
//     animationCloud3 = null;
//   }
//
//   LinearGradient getBackgroundColor() {
...
//     } else {
//       //白天
//       return LinearGradient(begin:Alignment.topCenter, end: Alignment.bottomCenter, colors: ColorsConfig.listColorsLightBlueSky);
//     }
//   }
//
//   @override
...
//             gradient: this.getBackgroundColor(),
//           ),
//         ),
//         this.widget.type == 0 ? Align(
...
//         Align(
//             alignment: Alignment(
//                 animationCloud1 != null ? animationCloud1?.value ?? 0  : cloud1X,
//                 cloud1Y),
//             child: Image.asset(R.assetsImgIcCloud1, width: 100, height: 100)),
//         //月亮的白云
//         Align(
//             alignment: Alignment(
//                 animationCloud2 != null ? animationCloud2?.value  ?? 0 : cloud2X,
//                 cloud2Y),
//             child: Image.asset(R.assetsImgIcCloud2, width: 70, height: 100)),
//         //左边的白云
//         Align(
//             alignment: Alignment(
//                 animationCloud3 != null ? animationCloud3?.value ?? 0  : cloud3X,
//                 cloud3Y),
