 ...
 * 创建文件夹页面
 */
class CreateObjectiveFolderPage extends BaseWidget {
  ...
  BaseWidgetState<BaseWidget> getState() {
    return _CreateObjectiveFolderPageState();
  }
}

class _CreateObjectiveFolderPageState<T>
    extends BaseWidgetState<CreateObjectiveFolderPage> {
  ...
  _CreateObjectiveFolderPageState() {
  ...
  void initData() {
    ...
    if (this.widget.folderModel.objectId != null) {
      this.folderModelForFolder = MongoApisManager.getInstance()
          .queryFolderModelForForFolderObjectId(
  ...
  @override
  void didUpdateWidget(CreateObjectiveFolderPage oldWidget) {
              ...
              child: SingleChildScrollView(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        padding:
                            const EdgeInsets.only(left: 8, bottom: 10, top: 15),
                        child: Text(
