...
class FileMessageWidget extends StatefulWidget {
  ...
  FileMessageWidget({required this.timelineMissionModel}) {}

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return FileMessageWidgetState();
  }
}

class FileMessageWidgetState extends State<FileMessageWidget>
  ...
  void initState() {
    try {
      Map map = jsonDecode(this.widget.timelineMissionModel.extra!);
    ...
    return InkWell(
        onTap: () {
          ...
          if (File(this.localUrl).existsSync() == true) {
            if (AudioPlayUtil.getInstance()?.audioPlayer?.playing == false ||
                AudioPlayUtil.getInstance()?.curPath != this.localUrl) {
              //没有播放中
              playUrl(this.localUrl);
            } else {
              if (AudioPlayUtil.getInstance()?.audioPlayer?.playing == true) {
        ...
        child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                    ...
                    children: [
                      Text(
                        this.widget.timelineMissionModel.eventType ==
                                "note_voice"
                      ...
                      Container(
                        ...
                        child: Text(
                          Utility.getDateTimeYMDHM(
                                  Utility.getDateTimeFromUTCString(this
                                      .widget
          ...
          decoration: BoxDecoration(
              color: this.widget.timelineMissionModel.eventType == ""
                  ? Color(0xff3499DD)
                  : Color(0xff6b62ec),
