...
part 'EndTimeMissionModel.g.dart';

@JsonSerializable()
class EndTimeMissionModel extends MongoDbObject{
  //博客内容
  ...
  // BmobDate time;
  // BmobFile pic;
  EndTimeMissionModel({this.message});

  //此处与类名一致，由指令自动生成代码
  factory EndTimeMissionModel.fromJson(Map<String, dynamic> json) =>
      _$EndTimeMissionModelFromJson(json);
  //此处与类名一致，由指令自动生成代码
  Map<String, dynamic> toJson() => _$EndTimeMissionModelToJson(this);
