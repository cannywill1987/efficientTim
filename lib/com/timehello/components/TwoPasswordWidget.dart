...
class TwoPasswordWidget extends StatefulWidget {
  double width;

  TwoPasswordWidget({Key? key, this.width = 200}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return TwoPasswordWidgetState();
  }
}

class TwoPasswordWidgetState extends State<TwoPasswordWidget> {
