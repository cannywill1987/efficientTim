...
class SelectSliderDurationDialogUtil {
...
class SelectSliderDurationDialog extends StatefulWidget {
   String? title; //标题
   String? content; //内容
  ...
  @override
  SelectSliderDurationDialogState createState() => SelectSliderDurationDialogState(
...
class SelectSliderDurationDialogState extends State<SelectSliderDurationDialog> {
  String? label = '';
   String? title; //标题
   String? content; //内容
   String? leftText; //左边按钮文字
  ...
  SelectSliderDurationDialogState(
      {this.onTapListener,
      this.title,
      this.content,
      this.leftText,
  ...
  @override
  void didUpdateWidget(SelectSliderDurationDialog oldWidget) {}
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Wrap(
                              ...
                              children: [
                                Text(
                                  this.counterEnum == CounterEnum.chronograph ? curSliderVal?.toInt().toString() ?? "" : getI18NKey().no_time_limit,
                                  textAlign: TextAlign.end,
                                  style: TextStyle(
                                      fontSize: this.counterEnum == CounterEnum.chronograph ? 36 : 30,
                                      fontWeight: FontWeight.bold),
                                ),
                                this.counterEnum == CounterEnum.chronograph ? SizedBox(
                                  width: 5,
                                ) : SizedBox.shrink(),
                                this.counterEnum == CounterEnum.chronograph ? Padding(
                                ...
                                onKey: (event) {
                                  if (event.runtimeType == RawKeyDownEvent) {
                                    if (event.physicalKey ==
                                      ...
                                      this.widget?.okCallBack!(counterEnum, curSliderVal);
                                    }
                                  }
                                },
                                focusNode: FocusNode(),
