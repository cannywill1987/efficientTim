...
class WQBCustomFolderModelSelectPopupWidget extends StatefulWidget {
  Function onSelected;
  // List<CheckButtonStateModel> list;
  Widget child;

  WQBCustomFolderModelSelectPopupWidget(
  ...
  State<StatefulWidget> createState() {
    ...
    return WQBCustomFolderModelSelectPopupWidgetState();
  }
}

class WQBCustomFolderModelSelectPopupWidgetState extends State<WQBCustomFolderModelSelectPopupWidget> {
  ...
  void requestData() async {
    List<WQBFolderModel> list = await MongoApisManager.getInstance()
        .queryWhereEqual_wqbfolderModelWithCircle();
    List<SheetDataModel> listSheetDataModel =
    Utility.getSheetDataModelFromWQBFolderModel(list, Icons.fiber_manual_record);
