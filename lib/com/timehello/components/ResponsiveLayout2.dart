...
class  ResponsiveLayout2 extends StatelessWidget {
  ...
  ResponsiveLayout2({required Key key, required this.onResizeListener, required this.mobileBody, required this.tabletBody, required this.desktopbody, required this.onOSListener}) : super (key: key);
