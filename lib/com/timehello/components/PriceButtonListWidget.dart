 ...
 * 底部按钮列表
 */
class PriceButtonListWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return PriceButtonListWidgetState(
        list: this.list, curIndex: this.initIndex ?? 0);
  }
}

class PriceButtonListWidgetState extends State<PriceButtonListWidget> {
  int curIndex = 0;
  List<CheckButtonStateModel> list;
  double fontSize = 13;

  PriceButtonListWidgetState({required this.curIndex, required this.list});
