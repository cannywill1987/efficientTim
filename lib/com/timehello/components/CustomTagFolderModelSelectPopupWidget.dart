...
class CustomTagFolderModelSelectPopupWidget extends StatefulWidget {
  Function onSelected;

  // List<CheckButtonStateModel> list;
  Widget child;

  CustomTagFolderModelSelectPopupWidget(
  ...
  State<StatefulWidget> createState() {
    ...
    return CustomTagFolderModelSelectPopupWidgetState();
  }
}

class CustomTagFolderModelSelectPopupWidgetState
    extends State<CustomTagFolderModelSelectPopupWidget> {
  ...
  void requestData() async {
    ...
    List<SheetDataModel> listSheetDataModel =
        Utility.getSheetDataModelFromFolderModel(list, Icons.sell);
