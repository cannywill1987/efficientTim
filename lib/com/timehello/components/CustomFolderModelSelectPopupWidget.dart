...
class CustomFolderModelSelectPopupWidget extends StatefulWidget {
  Function onSelected;
  // List<CheckButtonStateModel> list;
  Widget child;

  CustomFolderModelSelectPopupWidget(
  ...
  State<StatefulWidget> createState() {
    ...
    return CustomFolderModelSelectPopupWidgetState();
  }
}

class CustomFolderModelSelectPopupWidgetState extends State<CustomFolderModelSelectPopupWidget> {
