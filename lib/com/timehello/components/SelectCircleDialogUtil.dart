        ...
        builder: (BuildContext context) {
          // if (dialogContent == null) {
            return DialogContent(
                // key: Keys.SelectCircleDialogUtilStateGlobalKey,
                title: title,
                content: content,
                leftText: leftText,
                rightText: rightText,
...
class SelectCircleDialogContentState extends State<DialogContent> {
  ...
  void requestData() async {
    ...
    List<SheetDataModel> listSheetDataModel =
        Utility.getSheetDataModelFromFolderModel(list, Icons.fiber_manual_record);
                          ...
                          new ElevatedButton(
                            ...
                            style: ButtonStyle(
                                ...
                                textStyle: MaterialStateProperty.all(TextStyle(
                                    fontSize: 18, color: ThemeManager.getInstance().getTextColor(defaultColor: Colors.black)))),
                            onPressed: () {
                              Navigator.of(context).pop();
