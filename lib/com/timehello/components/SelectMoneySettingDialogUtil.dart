...
class SelectMoneySettingDialogUtil {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Slider(
                          ...
                          inactiveColor: ThemeManager.getInstance().getSliderInactiveColor(defaultColor: Color(0xfffdfdfd)),
                          value: (curSliderVal ?? 0) > (maxVal ?? 0)
                              ? (maxVal?.toDouble() ?? 1)
                              : (curSliderVal?.toDouble() ?? 0),
                          onChanged: (value) {
