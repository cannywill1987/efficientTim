...
class RatingDialog extends StatefulWidget {
  ...
  final Function? onDontRemindAgainListener;

  final Function? onClickCopyQQ;
  ...
  const RatingDialog({
    ...
    this.starSize = 40.0,
    this.onCancelled,
    this.onDontRemindAgainListener,
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 10,),
                this.isCommentShowed && widget.enableComment
                    ? TextField(
