...
class WQBCustomTagFolderModelSelectPopupWidget extends StatefulWidget {
  Function onSelected;
  // List<CheckButtonStateModel> list;
  Widget child;

  WQBCustomTagFolderModelSelectPopupWidget(
  ...
  State<StatefulWidget> createState() {
    ...
    return WQBCustomTagFolderModelSelectPopupWidgetState();
  }
}

class WQBCustomTagFolderModelSelectPopupWidgetState extends State<WQBCustomTagFolderModelSelectPopupWidget> {
