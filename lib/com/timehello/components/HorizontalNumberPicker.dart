...
class HorizontalNumberPicker extends StatefulWidget {
  ...
  double? paddingItemWidth;
   ...
   void Function(int) onSelectedChanged;
  ...
  HorizontalNumberPicker({
    ...
    listViewItemCount = (gridCount ?? 0) + 2;

    //空白item的宽度
    paddingItemWidth = widgetWidth / 2 - (gridWidth ?? 0) / 2;
          ...
          NotificationListener(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                //首尾空白元素
                if (index == 0 || index == (widget.listViewItemCount ?? 0)- 1) {
                  return Container(
                  ...
                  if (index == 1) {
                    type = 0;
                    //最后一个普通元素
                  } else if (index == ((widget.listViewItemCount ?? 0)- 2)) {
                    type = 2;
                    //中间普通元素
                  } else {
                    type = 1;
