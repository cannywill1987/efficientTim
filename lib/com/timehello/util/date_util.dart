...
/// Date Util.
class DateUtil {
  // 把时间戳转化成 yyyy.mm.dd hh:mm weekday
  static String getTimeString(int timestamp) {
    if(timestamp == null) {
      return "";
    }
      DateTime dateTime = DateTime.fromMillisecondsSinceEpoch(timestamp);
      DateFormat dateFormat = DateFormat('yyyy.MM.dd HH:mm EEEE');
  ...
  /// dateStr 日期字符串
  static String formatDateStr(String dateStr, {bool isUtc = false, required String format}) {
