...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m17(day, hour, mins, secs) => "${day}일 ${hour}:${mins}:${secs}";
  ...
  static String m22(title) => "카드 작업 \'${title}\' 생성";

  static String m23(title) => "목록 \'${title}\' 생성";

  static String m24(listing, title) => "목록 \'${listing}\'에 작업 \'${title}\' 생성";

  static String m25(title) => "작업 \'${title}\' 생성";

  static String m26(title) => "태그 \'${title}\' 생성";

  static String m27(Folder) => "${Folder} 생성";

  static String m28(tone) => "현재 벨소리:${tone}";

  static String m29(date1, date2) => "${date1}부터 ${date2}까지";

  static String m30(month, day) => "${month}월${day}일";

  static String m31(month, day, hour, mins) =>
      "${month}월${day}일,${hour}:${mins}";

  static String m32(money) => "${money}일 전";

  static String m33(money) => "${money}일 후";

  static String m34(title) => "체크인 미션 \'${title}\' 삭제";

  static String m35(note) => "데스크톱 위젯 ${note}";

  static String m36(title) => "제목 편집「${title}」";

  static String m37(n) => "하루에 ${n}번";

  static String m38(title, time, num) =>
      "앱을 떠나서 작업 \'${title}\'에 집중, ${time} 동안 집중하고 ${num} 가상 동전을 얻음";

  static String m39(title) => "작업 \'${title}\' 완료";

  static String m40(value) => "시간: ${value}";

  static String m41(value) => "수량: ${value}";

  static String m42(duraiton) => "완료 시간 ${duraiton}초";

  static String m43(correct, error, percent) =>
      "정답 ${correct}개, 오답 ${error}개, 정확도 ${percent}";

  static String m44(name) => "${name}을(를) 성공적으로 로컬로 가져왔습니다, 훈련을 시작할 수 있습니다";

  static String m45(app_name) => "${app_name}의 시간 관리자 역할";

  static String m46(title) => "\"${title}\"에 작업을 추가하고, \'Enter\'키를 눌러 저장하세요";

  static String m47(hour, min) => "${hour}시${min}분";

  static String m48(hour, min, sec) => "${hour}시${min}분${sec}초";

  static String m49(num) => "최대 ${num}자 입력 가능";

  static String m50(max) => "${max}자를 초과할 수 없습니다";

  static String m51(time) => "최대 녹음 시간:${time}";

  static String m52(min, sec) => "${min}분${sec}초";

  static String m53(year, month, day, weekday) =>
      "${year}년 ${month}월 ${day}일, ${weekday}";

  static String m54(month, day, year) => "${year}년 ${month}월 ${day}일";

  static String m55(month, year) => "${year}년 ${month}월";
  ...
  static String m58(name) => "\'${name}\' 작업 알림";

  static String m59(name) => "\'${name}\' 체크인 미션 알림";

  static String m60(submission, mission) =>
      "임무 ${mission}의 하위 임무 ${submission}이 시작되었습니다. 준비하세요";

  static String m61(title) => "작업 \"${title}\"";

  static String m62(value) => "먼저 시간당 가치를 설정하십시오 ${value}\$/시간";

  static String m63(title) => "목록 제목을 \'${title}\'로 수정";

  static String m64(title) => "태그를 \'${title}\'로 수정";

  static String m65(month, day, weekday) => "${month}월${day}일 ${weekday}";

  static String m66(month) => "${month}월 출근률";

  static String m67(month) => "${month}월 출근 기록";

  static String m68(course) => "나의 ${course}";

  static String m69(ranking) => "${ranking}위";

  static String m70(ranking) => "이번에 내 순위는 ${ranking}위입니다";

  static String m71(days) => "${days}일 연체";

  static String m72(newline) => "줄 바꿈:${newline}";

  static String m73(title, min, secs) => "${title}(남은 시간: ${min}:${secs})";
  ...
  static String m76(days) => "${days}일";

  static String m77(num) => "${num}분";

  static String m78(num, total) => "목록${num}/${total}";

  static String m79(num, total) => "${num}/${total}";

  static String m80(num) => "${num}개의 작업";

  static String m81(num) => "${num}회";

  static String m82(num) => "${num}개";

  static String m83(number) => "${number}개의 상품";

  static String m84(name) => "리스트「${name}」의 비밀번호를 입력해 주세요";

  static String m85(xxx) => "${xxx} 입력해주세요";

  static String m86(name) => "앱 스토어에서 \"${name}\"을(를) 검색해 주세요";

  static String m87(content) => "${content}을(를) 선택하세요";

  static String m88(present) => "${present}는 얼마의 돈을 사용하나요";

  static String m89(missionFinished, missionToDo, duration) =>
      "${missionFinished} 완료, ${missionToDo} 시작, ${missionToDo} 시간: ${duration}";

  static String m90(total) => "${total}회 반복";

  static String m91(value) => "시간: ${value}";

  static String m92(value) => "수량: ${value}";
  ...
  static String m94(title) => "작업 \'${title}\'에 집중 시작";

  static String m95(title) => "휴식 \'${title}\' 시작";

  static String m96(title, time, num) =>
      "작업 \'${title}\'에 집중 중지, ${time} 동안 집중하고 ${num} 가상 동전을 얻음";

  static String m97(title) => "휴식 \'${title}\' 중지";

  static String m98(money) => "${money} 전";

  static String m99(money) => "${money} 후";

  static String m100(date) => "${date} 데이터";
  ...
  static String m102(trainee) => "${trainee}의 조언";

  static String m103(time) => "마지막 업데이트 시간:${time}";

  static String m104(listing, title) =>
      "목록 \'${listing}\'에 작업 \'${title}\' 업데이트";

  static String m105(title) => "작업 \'${title}\' 업데이트";

  static String m106(value) => "가치:${value}";

  static String m107(value) => "${value}\$/시간";

  static String m108(version) => "현재 버전 ${version}";

  static String m109(appName) => "\"${appName}\"에 오신 것을 환영합니다";

  static String m110(diary) => "일기 \'${diary}\'를 작성했습니다";

  static String m111(diary) => "노트 \'${diary}\'를 작성했습니다";

  static String m112(text) => "${text}은(는) 비워 둘 수 없습니다";

  static String m113(month, year) => "${year}년 ${month}월";

  static String m114(name) => "당신이 설정한 체크인 미션 \'${name}\'이 시작되었습니다. 체크인을 해주세요";

  static String m115(name) => "당신의 \'${name}\' 작업 알림이 시작되었습니다. 준비하세요";
