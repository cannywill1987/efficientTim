...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(numbers) => "일괄 완료 \'${numbers}\' 작업";

  static String m1(numbers) => "일괄 삭제 \'${numbers}\' 작업";

  static String m2(numbers) => "일괄 미완료 \'${numbers}\' 작업";

  static String m3(numbers) => "일괄 업데이트 \'${numbers}\' 작업";

  static String m4(numTotatoes, duration, time, minute) =>
      "예상 토마토 시간:${numTotatoes} x ${duration} 분 = ${time}시간${minute}분";

  static String m5(times) => "연속 ${times}일 출근";

  static String m6(n) => "총 ${n}일 출근";

  static String m7(title) => "체크인 미션 \'${title}\' 완료";

  static String m8(title, num) => "작업 \'${title}\'에 집중 완료, ${num} 가상 동전을 얻음";

  static String m9(title, time, num) =>
      "작업 \'${title}\'에 한 번 집중 완료, ${time} 동안 집중하고 ${num} 가상 동전을 얻음";

  static String m10(title) => "휴식 \'${title}\' 완료";

  static String m11(title) => "휴식 \'${title}\' 완료";

  static String m12(name) => "${name}";

  static String m13(folderName) => "폴더\"${folderName}\"를 삭제하시겠습니까?";

  static String m14(folderName) =>
      "폴더\"${folderName}\"의 목록과 관련 하위 작업을 삭제하시겠습니까?";

  static String m15(money) => "\'${money}\' 금액 소비 (수동 입력)";
  ...
  static String m18(day, hour, mins, secs) => "${day}일 ${hour}:${mins}:${secs}";
  ...
  static String m23(title) => "카드 작업 \'${title}\' 생성";

  static String m24(title) => "목록 \'${title}\' 생성";

  static String m25(listing, title) => "목록 \'${listing}\'에 작업 \'${title}\' 생성";

  static String m26(title) => "작업 \'${title}\' 생성";

  static String m27(title) => "태그 \'${title}\' 생성";

  static String m28(Folder) => "${Folder} 생성";

  static String m29(tone) => "현재 벨소리:${tone}";

  static String m30(date1, date2) => "${date1}부터 ${date2}까지";

  static String m31(month, day) => "${month}월${day}일";

  static String m32(month, day, hour, mins) =>
      "${month}월${day}일,${hour}:${mins}";

  static String m33(money) => "${money}일 전";

  static String m34(money) => "${money}일 후";

  static String m35(title) => "체크인 미션 \'${title}\' 삭제";

  static String m36(note) => "데스크톱 위젯 ${note}";

  static String m37(title) => "제목 편집「${title}」";

  static String m38(n) => "하루에 ${n}번";

  static String m39(title, time, num) =>
      "앱을 떠나서 작업 \'${title}\'에 집중, ${time} 동안 집중하고 ${num} 가상 동전을 얻음";

  static String m40(title) => "작업 \'${title}\' 완료";

  static String m41(value) => "시간: ${value}";

  static String m42(value) => "수량: ${value}";

  static String m43(duraiton) => "완료 시간 ${duraiton}초";

  static String m44(correct, error, percent) =>
      "정답 ${correct}개, 오답 ${error}개, 정확도 ${percent}";

  static String m45(name) => "${name}을(를) 성공적으로 로컬로 가져왔습니다, 훈련을 시작할 수 있습니다";

  static String m46(app_name) => "${app_name}의 시간 관리자 역할";

  static String m47(id) => "그룹 ID: ${id}";

  static String m48(title) => "\"${title}\"에 작업을 추가하고, \'Enter\'키를 눌러 저장하세요";

  static String m49(hour, min) => "${hour}시${min}분";

  static String m50(hour, min, sec) => "${hour}시${min}분${sec}초";

  static String m51(num) => "최대 ${num}자 입력 가능";

  static String m52(max) => "${max}자를 초과할 수 없습니다";

  static String m53(time) => "최대 녹음 시간:${time}";

  static String m54(min, sec) => "${min}분${sec}초";

  static String m55(year, month, day, weekday) =>
      "${year}년 ${month}월 ${day}일, ${weekday}";

  static String m56(month, day, year) => "${year}년 ${month}월 ${day}일";

  static String m57(month, year) => "${year}년 ${month}월";
  ...
  static String m60(name) => "\'${name}\' 작업 알림";

  static String m61(name) => "\'${name}\' 체크인 미션 알림";

  static String m62(submission, mission) =>
      "임무 ${mission}의 하위 임무 ${submission}이 시작되었습니다. 준비하세요";

  static String m63(title) => "작업 \"${title}\"";

  static String m64(value) => "먼저 시간당 가치를 설정하십시오 ${value}\$/시간";

  static String m65(title) => "목록 제목을 \'${title}\'로 수정";

  static String m66(title) => "태그를 \'${title}\'로 수정";

  static String m67(month, day, weekday) => "${month}월${day}일 ${weekday}";

  static String m68(month) => "${month}월 출근률";

  static String m69(month) => "${month}월 출근 기록";

  static String m70(course) => "나의 ${course}";

  static String m71(ranking) => "${ranking}위";

  static String m72(ranking) => "이번에 내 순위는 ${ranking}위입니다";

  static String m73(days) => "${days}일 연체";

  static String m74(newline) => "줄 바꿈:${newline}";

  static String m75(title, min, secs) => "${title}(남은 시간: ${min}:${secs})";
  ...
  static String m78(days) => "${days}일";

  static String m79(num) => "${num}분";

  static String m80(num, total) => "목록${num}/${total}";

  static String m81(num, total) => "${num}/${total}";

  static String m82(num) => "${num}개의 작업";

  static String m83(num) => "${num}회";

  static String m84(num) => "${num}개";

  static String m85(number) => "${number}개의 상품";

  static String m86(name) => "리스트「${name}」의 비밀번호를 입력해 주세요";

  static String m87(xxx) => "${xxx} 입력해주세요";

  static String m88(name) => "앱 스토어에서 \"${name}\"을(를) 검색해 주세요";

  static String m89(content) => "${content}을(를) 선택하세요";

  static String m90(present) => "${present}는 얼마의 돈을 사용하나요";

  static String m91(missionFinished, missionToDo, duration) =>
      "${missionFinished} 완료, ${missionToDo} 시작, ${missionToDo} 시간: ${duration}";

  static String m92(total) => "${total}회 반복";

  static String m93(value) => "시간: ${value}";

  static String m94(value) => "수량: ${value}";
  ...
  static String m96(app_name, code) =>
      "${app_name}의 그룹 리스트 번호는 ${code}입니다. ${app_name}을 다운로드하고 그룹 리스트 번호를 입력하면 파트너와 함께 작업할 수 있습니다.";

  static String m97(title) => "작업 \'${title}\'에 집중 시작";

  static String m98(title) => "휴식 \'${title}\' 시작";

  static String m99(title, time, num) =>
      "작업 \'${title}\'에 집중 중지, ${time} 동안 집중하고 ${num} 가상 동전을 얻음";

  static String m100(title) => "휴식 \'${title}\' 중지";

  static String m101(money) => "${money} 전";

  static String m102(money) => "${money} 후";

  static String m103(date) => "${date} 데이터";
  ...
  static String m105(trainee) => "${trainee}의 조언";

  static String m106(time) => "마지막 업데이트 시간:${time}";

  static String m107(listing, title) =>
      "목록 \'${listing}\'에 작업 \'${title}\' 업데이트";

  static String m108(title) => "작업 \'${title}\' 업데이트";

  static String m109(value) => "가치:${value}";

  static String m110(value) => "${value}\$/시간";

  static String m111(version) => "현재 버전 ${version}";

  static String m112(appName) => "\"${appName}\"에 오신 것을 환영합니다";

  static String m113(diary) => "일기 \'${diary}\'를 작성했습니다";

  static String m114(diary) => "노트 \'${diary}\'를 작성했습니다";

  static String m115(text) => "${text}은(는) 비워 둘 수 없습니다";

  static String m116(month, year) => "${year}년 ${month}월";

  static String m117(name) => "당신이 설정한 체크인 미션 \'${name}\'이 시작되었습니다. 체크인을 해주세요";

  static String m118(name) => "당신의 \'${name}\' 작업 알림이 시작되었습니다. 준비하세요";
