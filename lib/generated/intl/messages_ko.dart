...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m20(existing_text) =>
      "다음 내용을 바탕으로 글쓰기를 계속하세요:\n\n${existing_text}\n\n다음:";

  static String m21(title, link) => "작업 ${title}의 내용을 보려면 링크를 클릭하세요: ${link}";
  ...
  static String m24(day, hour, mins, secs) => "${day}일 ${hour}:${mins}:${secs}";

  static String m25(hour, mins, secs) => "${hour}:${mins}:${secs}";

  static String m26(mins, secs) => "${mins}:${secs}";

  static String m27(day, hour, mins, secs) => "${day}일 ${hour}:${mins}:${secs}";
  ...
  static String m32(title) => "카드 작업 \'${title}\' 생성";

  static String m33(title) => "목록 \'${title}\' 생성";

  static String m34(listing, title) => "목록 \'${listing}\'에 작업 \'${title}\' 생성";

  static String m35(title) => "작업 \'${title}\' 생성";

  static String m36(title) => "태그 \'${title}\' 생성";

  static String m37(Folder) => "${Folder} 생성";

  static String m38(currencySymbol, price) => "${currencySymbol}${price} / 월";

  static String m39(currencySymbol, price) => "${currencySymbol}${price} / 연";

  static String m40(tone) => "현재 벨소리:${tone}";

  static String m41(date1, date2) => "${date1}부터 ${date2}까지";

  static String m42(month, day) => "${month}월${day}일";
  ...
  static String m45(money) => "${money}일 전";

  static String m46(money) => "${money}일 후";

  static String m47(title) => "체크인 미션 \'${title}\' 삭제";

  static String m48(note) => "데스크톱 위젯 ${note}";

  static String m49(title) => "제목 편집「${title}」";
  ...
  static String m52(n) => "하루에 ${n}번";

  static String m53(title, time, num) =>
      "앱을 떠나서 작업 \'${title}\'에 집중, ${time} 동안 집중하고 ${num} 가상 동전을 얻음";

  static String m54(title) => "작업 \'${title}\' 완료";

  static String m55(value) => "시간: ${value}";

  static String m56(value) => "수량: ${value}";

  static String m57(duraiton) => "완료 시간 ${duraiton}초";

  static String m58(correct, error, percent) =>
      "정답 ${correct}개, 오답 ${error}개, 정확도 ${percent}";

  static String m59(name) => "${name}을(를) 성공적으로 로컬로 가져왔습니다, 훈련을 시작할 수 있습니다";

  static String m60(app_name) => "${app_name}의 시간 관리자 역할";

  static String m61(id) => "그룹 ID: ${id}";

  static String m62(title) => "\"${title}\"에 작업을 추가하고, \'Enter\'키를 눌러 저장하세요";

  static String m63(hour, min) => "${hour}시${min}분";

  static String m64(hour, min, sec) => "${hour}시${min}분${sec}초";

  static String m65(wordCount, charCount) =>
      "(선택된) 단어 수: ${wordCount}, 문자 수: ${charCount}";

  static String m66(xxx) => "${xxx}로 이동";

  static String m67(num) => "최대 ${num}자 입력 가능";

  static String m68(max) => "${max}자를 초과할 수 없습니다";

  static String m69(time) => "최대 녹음 시간:${time}";

  static String m70(min, sec) => "${min}분${sec}초";

  static String m71(value) => "시급 ${value}\$";

  static String m72(year, month, day, weekday) =>
      "${year}년 ${month}월 ${day}일, ${weekday}";

  static String m73(month, day, year) => "${year}년 ${month}월 ${day}일";

  static String m74(month, year) => "${year}년 ${month}월";
  ...
  static String m77(name) => "\'${name}\' 작업 알림";

  static String m78(name) => "\'${name}\' 체크인 미션 알림";

  static String m79(submission, mission) =>
      "임무 ${mission}의 하위 임무 ${submission}이 시작되었습니다. 준비하세요";

  static String m80(title) => "작업 \"${title}\"";

  static String m81(value) => "먼저 시간당 가치를 설정하십시오 ${value}\$/시간";

  static String m82(title) => "목록 제목을 \'${title}\'로 수정";

  static String m83(title) => "태그를 \'${title}\'로 수정";

  static String m84(month, day, weekday) => "${month}월${day}일 ${weekday}";

  static String m85(month) => "${month}월 출근률";

  static String m86(month) => "${month}월 출근 기록";

  static String m87(course) => "나의 ${course}";

  static String m88(ranking) => "${ranking}위";

  static String m89(ranking) => "이번에 내 순위는 ${ranking}위입니다";

  static String m90(days) => "${days}일 연체";

  static String m91(newline) => "줄 바꿈:${newline}";

  static String m92(title, min, secs) => "${title}(남은 시간: ${min}:${secs})";
  ...
  static String m95(days) => "${days}일";

  static String m96(num) => "${num}분";

  static String m97(num, total) => "${num} 임무 / ${total} 총 임무";

  static String m98(num, total) => "목록${num}/${total}";

  static String m99(num, total) => "${num}/${total}";

  static String m100(num) => "${num}개의 작업";

  static String m101(num) => "${num}회";

  static String m102(num) => "${num} 토마토";

  static String m103(num) => "${num}개";

  static String m104(number) => "${number}개의 상품";

  static String m105(name) => "리스트「${name}」의 비밀번호를 입력해 주세요";

  static String m106(xxx) => "${xxx} 입력해주세요";

  static String m107(name) => "앱 스토어에서 \"${name}\"을(를) 검색해 주세요";

  static String m108(content) => "${content}을(를) 선택하세요";

  static String m109(present) => "${present}는 얼마의 돈을 사용하나요";

  static String m110(missionFinished, missionToDo, duration) =>
      "${missionFinished} 완료, ${missionToDo} 시작, ${missionToDo} 시간: ${duration}";

  static String m111(title, percent) => "작업 ${title} 완료율 ${percent}";

  static String m112(title, percent, folderTitle, folderPercent) =>
      "작업 ${title} 완료율 ${percent}%, 목표 목록 ${folderTitle} 완료율 ${folderPercent}%";

  static String m113(total) => "${total}회 반복";

  static String m114(value) => "시간: ${value}";

  static String m115(value) => "수량: ${value}";
  ...
  static String m118(title) => "작업 \'${title}\'에 집중 시작";

  static String m119(title) => "휴식 \'${title}\' 시작";

  static String m120(title, time, num) =>
      "작업 \'${title}\'에 집중 중지, ${time} 동안 집중하고 ${num} 가상 동전을 얻음";

  static String m121(title) => "휴식 \'${title}\' 중지";

  static String m122(money) => "${money} 전";

  static String m123(money) => "${money} 후";

  static String m124(appname) => "${appname} AI";

  static String m125(date) => "${date} 데이터";

  static String m126(num) => "총 ${num}";

  static String m127(num) => "총 ${num} 토마토";
  ...
  static String m129(trainee) => "${trainee}의 조언";

  static String m130(time) => "마지막 업데이트 시간:${time}";

  static String m131(listing, title) =>
      "목록 \'${listing}\'에 작업 \'${title}\' 업데이트";

  static String m132(title) => "작업 \'${title}\' 업데이트";

  static String m133(value) => "가치:${value}";

  static String m134(value) => "${value}\$/시간";

  static String m135(version) => "현재 버전 ${version}";

  static String m136(appName) => "\"${appName}\"에 오신 것을 환영합니다";

  static String m137(wordCount, charCount) =>
      "단어 수: ${wordCount}, 문자 수: ${charCount}";

  static String m138(diary) => "일기 \'${diary}\'를 작성했습니다";

  static String m139(diary) => "노트 \'${diary}\'를 작성했습니다";

  static String m140(text) => "${text}은(는) 비워 둘 수 없습니다";

  static String m141(month, year) => "${year}년 ${month}월";

  static String m142(name) => "당신이 설정한 체크인 미션 \'${name}\'이 시작되었습니다. 체크인을 해주세요";

  static String m143(name) => "당신의 \'${name}\' 작업 알림이 시작되었습니다. 준비하세요";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "advanced_reminders": MessageLookupByLibrary.simpleMessage("고급 알림"),
        "advanced_search": MessageLookupByLibrary.simpleMessage("고급 검색"),
        "advanced_search_description":
            MessageLookupByLibrary.simpleMessage("정확한 검색으로 작업을 찾습니다."),
        "advertising_copy": MessageLookupByLibrary.simpleMessage("광고 문안"),
        "advertising_copy_placeholder":
            MessageLookupByLibrary.simpleMessage("광고 문안의 제품 또는 서비스를 입력하세요..."),
        ...
        "ai_helper_description":
            MessageLookupByLibrary.simpleMessage("AI 추천으로 작업 및 목록을 생성합니다."),
        "ai_placeholder":
        ...
        "ai_title": MessageLookupByLibrary.simpleMessage("시간 관리 AI"),
        ...
        "already_purchased": MessageLookupByLibrary.simpleMessage("이미 구매됨"),
        ...
        "announcement_placeholder":
            MessageLookupByLibrary.simpleMessage("공지사항의 구체적인 내용을 입력하세요..."),
        ...
        "app_ai_voice_cancel_recording":
            MessageLookupByLibrary.simpleMessage("녹음 취소"),
        "app_ai_voice_recording": MessageLookupByLibrary.simpleMessage("녹음 중"),
        "app_ai_voice_stop_hint": MessageLookupByLibrary.simpleMessage(
            "종료를 누르면 녹음을 마칩니다. 취소하면 삭제됩니다."),
        "app_ai_voice_stop_recording":
            MessageLookupByLibrary.simpleMessage("녹음 종료"),
        "app_ai_voice_transcribing":
            MessageLookupByLibrary.simpleMessage("인식 중"),
        "app_ai_voice_transcribing_action":
            MessageLookupByLibrary.simpleMessage("인식 중"),
        "app_ai_voice_transcribing_hint":
            MessageLookupByLibrary.simpleMessage("텍스트로 변환 중..."),
        "app_name": MessageLookupByLibrary.simpleMessage("시간 관리국 ToDo"),
        "app_tagline_focus_efficient_life":
            MessageLookupByLibrary.simpleMessage("집중 시간 | 효율적인 생활"),
        "appearance_themes": MessageLookupByLibrary.simpleMessage("외형 테마"),
        "apple_alarm": MessageLookupByLibrary.simpleMessage("Apple 알람"),
        "apple_calendar": MessageLookupByLibrary.simpleMessage("Apple 캘린더"),
        "apple_login": MessageLookupByLibrary.simpleMessage("애플 로그인"),
        "apply_action": MessageLookupByLibrary.simpleMessage("적용"),
        ...
        "auto_renew_after_trial": MessageLookupByLibrary.simpleMessage(
            "체험 후, 자동으로 갱신됩니다. 언제든지 취소 가능합니다. 업그레이드함으로써 EULA 및 개인정보처리방침에 동의하게 됩니다."),
        ...
        "backgroundColorGreen": MessageLookupByLibrary.simpleMessage("녹색 배경"),
        ...
        "benefits": MessageLookupByLibrary.simpleMessage("혜택"),
        "between_date": m6,
        ...
        "built_in_microphone": MessageLookupByLibrary.simpleMessage("내장 마이크"),
        ...
        "calendar_month_view":
            MessageLookupByLibrary.simpleMessage("캘린더 월간 보기"),
        "calendar_month_view_description":
            MessageLookupByLibrary.simpleMessage("그리드를 사용하여 매일의 작업 일정을 확인합니다."),
        "calendar_timeline_view":
            MessageLookupByLibrary.simpleMessage("캘린더 타임라인 보기"),
        "calendar_timeline_view_description":
            MessageLookupByLibrary.simpleMessage("하루 24시간을 한눈에 확인합니다."),
        "calendar_view": MessageLookupByLibrary.simpleMessage("달력 보기"),
        ...
        "check_item_reminder": MessageLookupByLibrary.simpleMessage("항목 확인 알림"),
        "check_item_reminder_description":
            MessageLookupByLibrary.simpleMessage("중요 항목별로 알림을 설정합니다."),
        ...
        "cmdCopySelection": MessageLookupByLibrary.simpleMessage("선택 항목 복사"),
        "cmdCutSelection": MessageLookupByLibrary.simpleMessage("선택 항목 잘라내기"),
        ...
        "cmdMoveCursorLeft":
            MessageLookupByLibrary.simpleMessage("커서를 왼쪽으로 이동"),
        "cmdMoveCursorLeftSelect":
            MessageLookupByLibrary.simpleMessage("왼쪽으로 선택"),
        "cmdMoveCursorLineEnd":
            MessageLookupByLibrary.simpleMessage("커서를 줄 끝으로 이동"),
        "cmdMoveCursorLineEndSelect":
            MessageLookupByLibrary.simpleMessage("줄 끝까지 선택"),
        "cmdMoveCursorLineStart":
            MessageLookupByLibrary.simpleMessage("커서를 줄 시작으로 이동"),
        "cmdMoveCursorLineStartSelect":
            MessageLookupByLibrary.simpleMessage("줄 시작까지 선택"),
        "cmdMoveCursorRight":
            MessageLookupByLibrary.simpleMessage("커서를 오른쪽으로 이동"),
        ...
        "cmdPasteContentAsPlainText":
            MessageLookupByLibrary.simpleMessage("내용을 일반 텍스트로 붙여넣기"),
        "cmdRedo": MessageLookupByLibrary.simpleMessage("다시 실행"),
        "cmdScrollPageDown":
            MessageLookupByLibrary.simpleMessage("페이지 아래로 스크롤"),
        "cmdScrollPageUp": MessageLookupByLibrary.simpleMessage("페이지 위로 스크롤"),
        ...
        "cmdTableMoveToDownCellAtSameOffset":
            MessageLookupByLibrary.simpleMessage("같은 오프셋에서 아래 셀로 이동"),
        "cmdTableMoveToLeftCellIfItsAtStartOfCurrentCell":
            MessageLookupByLibrary.simpleMessage("현재 셀의 시작일 때 왼쪽 셀로 이동"),
        "cmdTableMoveToRightCellIfItsAtTheEndOfCurrentCell":
            MessageLookupByLibrary.simpleMessage("현재 셀의 끝일 때 오른쪽 셀로 이동"),
        "cmdTableMoveToUpCellAtSameOffset":
            MessageLookupByLibrary.simpleMessage("같은 오프셋에서 위 셀로 이동"),
        "cmdTableNavigateCells":
            MessageLookupByLibrary.simpleMessage("같은 오프셋에서 셀 탐색"),
        "cmdTableNavigateCellsReverse":
            MessageLookupByLibrary.simpleMessage("같은 오프셋에서 셀 역방향 탐색"),
        "cmdTableStopAtTheBeginningOfTheCell":
            MessageLookupByLibrary.simpleMessage("셀의 시작에서 멈춤"),
        ...
        "colAddAfter": MessageLookupByLibrary.simpleMessage("다음 열 추가"),
        "colAddBefore": MessageLookupByLibrary.simpleMessage("이전 열 추가"),
        ...
        "complete_ratio": MessageLookupByLibrary.simpleMessage("완료율"),
        ...
        "continue_writing": MessageLookupByLibrary.simpleMessage("글쓰기 계속"),
        "continue_writing_prompt": MessageLookupByLibrary.simpleMessage(
            "선택한 단락을 바탕으로 내용을 확장하여 글쓰기를 계속하세요."),
        ...
        "count_up2": m28,
        "count_up3": m29,
        "count_up_text": MessageLookupByLibrary.simpleMessage("기념일"),
        "countdown": MessageLookupByLibrary.simpleMessage("카운트다운"),
        "countdown_description": MessageLookupByLibrary.simpleMessage(
            "카운트다운 및 위젯이 중요한 순간을 계속 알려줍니다."),
        ...
        "create_countup": MessageLookupByLibrary.simpleMessage("기념일 만들기"),
        ...
        "create_more_achieve_more":
            MessageLookupByLibrary.simpleMessage("더 많이 만들고, 더 많이 달성하세요"),
        ...
        "creative_story": MessageLookupByLibrary.simpleMessage("창작 이야기"),
        "creative_story_placeholder":
            MessageLookupByLibrary.simpleMessage("창작 이야기의 줄거리나 주제를 입력하세요..."),
        "creative_story_prompt":
            MessageLookupByLibrary.simpleMessage("창작 이야기를 작성해 주세요, 줄거리는..."),
        ...
        "current_duration": MessageLookupByLibrary.simpleMessage("현재 길이"),
        "custom": MessageLookupByLibrary.simpleMessage("사용자 정의"),
        "customColor": MessageLookupByLibrary.simpleMessage("사용자 정의 색상"),
        "custom_theme": MessageLookupByLibrary.simpleMessage("맞춤 테마"),
        "custom_theme_description": MessageLookupByLibrary.simpleMessage(
            "인터페이스를 위한 다양한 테마 시리즈를 사용자 정의할 수 있습니다."),
        "custom_themes": MessageLookupByLibrary.simpleMessage("맞춤 테마"),
        "customize": MessageLookupByLibrary.simpleMessage("사용자 정의"),
        "customize_appearance":
            MessageLookupByLibrary.simpleMessage("취향에 맞게 외형을 맞춤 설정"),
        ...
        "daily_selection": MessageLookupByLibrary.simpleMessage("매일 선정"),
        ...
        "data_analysis": MessageLookupByLibrary.simpleMessage("데이터 분석"),
        "data_statistics": MessageLookupByLibrary.simpleMessage("데이터 통계"),
        ...
        "desktop_widget": MessageLookupByLibrary.simpleMessage("데스크톱 위젯"),
        "desktop_widget_description": MessageLookupByLibrary.simpleMessage(
            "목록, 사분면, 카운트다운, 캘린더, 체크인 등의 풍부한 위젯."),
        "desktop_widget_with_note_n": m48,
        "detailed_analysis_reports":
            MessageLookupByLibrary.simpleMessage("상세한 분석 및 보고서"),
        ...
        "edit_options": MessageLookupByLibrary.simpleMessage("편집 옵션"),
        ...
        "editor_recommendation": MessageLookupByLibrary.simpleMessage("편집자 추천"),
        ...
        "emoji_conversion_placeholder":
            MessageLookupByLibrary.simpleMessage("이모지로 변환할 텍스트를 입력하세요..."),
        ...
        "enjoy_10x_expansion":
            MessageLookupByLibrary.simpleMessage("10배 확장 즐기기"),
        "enrich": MessageLookupByLibrary.simpleMessage("풍부하게"),
        "enrich_prompt":
            MessageLookupByLibrary.simpleMessage("선택한 단락을 더 풍부하고 자세하게 만드세요."),
        ...
        "enter_objective_title":
            MessageLookupByLibrary.simpleMessage("이 목표의 목표 제목을 입력하세요"),
        "enter_total_value":
            MessageLookupByLibrary.simpleMessage("이 목표의 목표 값을 입력하세요 (정수)"),
        "enter_unit":
            MessageLookupByLibrary.simpleMessage("단위를 입력하세요 (예: 원, 개, 번 등)"),
        ...
        "explain": MessageLookupByLibrary.simpleMessage("설명"),
        "explain_prompt":
            MessageLookupByLibrary.simpleMessage("선택한 단락의 주요 내용과 의미를 설명하세요."),
        ...
        "features_components": MessageLookupByLibrary.simpleMessage("기능 구성 요소"),
        "features_privileges": MessageLookupByLibrary.simpleMessage("기능 특권"),
        ...
        "filter_description":
            MessageLookupByLibrary.simpleMessage("사용자 정의 필터로 작업을 필터링합니다."),
        ...
        "fix_spelling_grammar":
            MessageLookupByLibrary.simpleMessage("맞춤법 및 문법 수정"),
        "fix_spelling_grammar_prompt": MessageLookupByLibrary.simpleMessage(
            "선택한 단락의 맞춤법 및 문법 오류를 확인하고 수정하세요."),
        ...
        "focus_companion": MessageLookupByLibrary.simpleMessage("집중 파트너"),
        "focus_companion_active": MessageLookupByLibrary.simpleMessage("집중"),
        "focus_companion_less": MessageLookupByLibrary.simpleMessage("적음"),
        "focus_companion_most": MessageLookupByLibrary.simpleMessage("최대"),
        ...
        "focus_ranking": MessageLookupByLibrary.simpleMessage("집중 랭킹"),
        ...
        "fontColorGreen": MessageLookupByLibrary.simpleMessage("녹색"),
        ...
        "food_reviews": MessageLookupByLibrary.simpleMessage("음식 리뷰"),
        "food_reviews_placeholder":
            MessageLookupByLibrary.simpleMessage("리뷰할 레스토랑과 요리를 입력하세요..."),
        "food_reviews_prompt":
            MessageLookupByLibrary.simpleMessage("음식 리뷰를 작성해 주세요, 레스토랑은..."),
        "four_pws":
        ...
        "free_check_in": MessageLookupByLibrary.simpleMessage(
            "고정된 시간이 없으며, 언제든지 체크인하여 목표 진행 상황을 업데이트할 수 있습니다"),
        ...
        "from_calendar": MessageLookupByLibrary.simpleMessage("캘린더에서"),
        "from_reminder": MessageLookupByLibrary.simpleMessage("리마인더에서"),
        ...
        "give_up": MessageLookupByLibrary.simpleMessage("포기"),
        ...
        "group_id": m61,
        "group_listing": MessageLookupByLibrary.simpleMessage("그룹 목록"),
        ...
        "improve_writing": MessageLookupByLibrary.simpleMessage("글쓰기 개선"),
        "improve_writing_prompt": MessageLookupByLibrary.simpleMessage(
            "선택한 단락을 더 명확하고 표현력 있게 개선하세요."),
        ...
        "input_value_hint": MessageLookupByLibrary.simpleMessage("값 입력"),
        "input_your_goal":
        ...
        "interview_questions": MessageLookupByLibrary.simpleMessage("인터뷰 질문"),
        "interview_questions_placeholder":
            MessageLookupByLibrary.simpleMessage("인터뷰 대상자 및 관련 질문을 입력하세요..."),
        "interview_questions_prompt": MessageLookupByLibrary.simpleMessage(
            "인터뷰 질문을 작성해 주세요, 인터뷰 대상자는..."),
        ...
        "job_description": MessageLookupByLibrary.simpleMessage("직무 설명"),
        "job_description_placeholder":
            MessageLookupByLibrary.simpleMessage("직위와 책임을 입력하세요..."),
        "job_description_prompt":
            MessageLookupByLibrary.simpleMessage("직무 설명을 작성해 주세요, 직위는..."),
        ...
        "join_us": MessageLookupByLibrary.simpleMessage("가입하기"),
        ...
        "leave_reason_placeholder":
            MessageLookupByLibrary.simpleMessage("휴가 사유를 입력하세요..."),
        "leave_reason_prompt":
            MessageLookupByLibrary.simpleMessage("휴가 사유 작성을 도와주세요, 이유는..."),
        ...
        "life_recording": MessageLookupByLibrary.simpleMessage("생활 기록"),
        "life_recording_review": MessageLookupByLibrary.simpleMessage(
            "월간 보기를 사용해 독서, 운동, 학습 일지 등을 기록하는 것을 좋아합니다. 월간 보기를 돌아볼 때마다 한 달 동안 이렇게 많은 일을 할 수 있었던 것에 놀라고 기쁩니다."),
        ...
        "lightLightTint7": MessageLookupByLibrary.simpleMessage("녹색"),
        ...
        "link_wechat": MessageLookupByLibrary.simpleMessage("WeChat 연결"),
        ...
        "lock_app_settings": MessageLookupByLibrary.simpleMessage("앱 설정 잠금"),
        "lock_app_settings_description": MessageLookupByLibrary.simpleMessage(
            "Apple 기기에서 특정 시간 동안 앱 잠금 기능을 지원합니다."),
        ...
        "login_to_view_focus_ranking":
            MessageLookupByLibrary.simpleMessage("로그인 후 집중 랭킹 보기"),
        ...
        "max_input_num": m67,
        "max_record_duration": MessageLookupByLibrary.simpleMessage("최대 녹음"),
        "max_words": m68,
        ...
        "me_too": MessageLookupByLibrary.simpleMessage("나도"),
        "meeting_agenda": MessageLookupByLibrary.simpleMessage("회의 안건"),
        "meeting_agenda_placeholder":
            MessageLookupByLibrary.simpleMessage("회의 안건의 주제나 내용을 입력하세요..."),
        "meeting_agenda_prompt":
            MessageLookupByLibrary.simpleMessage("회의 안건을 작성해 주세요, 회의 주제는..."),
        ...
        "mine_menu_subtitle_ai_assistant":
            MessageLookupByLibrary.simpleMessage("스마트 도우미"),
        "mine_menu_subtitle_capture_ideas":
            MessageLookupByLibrary.simpleMessage("영감 기록"),
        "mine_menu_subtitle_community":
            MessageLookupByLibrary.simpleMessage("커뮤니티"),
        "mine_menu_subtitle_daily_record":
            MessageLookupByLibrary.simpleMessage("일일 기록"),
        "mine_menu_subtitle_data_management":
            MessageLookupByLibrary.simpleMessage("데이터 관리"),
        "mine_menu_subtitle_focus_timing":
            MessageLookupByLibrary.simpleMessage("집중 타이머"),
        "mine_menu_subtitle_focus_training":
            MessageLookupByLibrary.simpleMessage("집중력 향상"),
        "mine_menu_subtitle_habit_building":
            MessageLookupByLibrary.simpleMessage("습관 만들기"),
        "mine_menu_subtitle_important_days":
            MessageLookupByLibrary.simpleMessage("중요한 날"),
        "mine_menu_subtitle_interface_theme":
            MessageLookupByLibrary.simpleMessage("화면 테마"),
        "mine_menu_subtitle_knowledge_cards":
            MessageLookupByLibrary.simpleMessage("지식 카드"),
        "mine_menu_subtitle_lock_screen_widget":
            MessageLookupByLibrary.simpleMessage("잠금 화면 위젯"),
        "mine_menu_subtitle_memo_reminder":
            MessageLookupByLibrary.simpleMessage("메모 알림"),
        "mine_menu_subtitle_note_management":
            MessageLookupByLibrary.simpleMessage("노트 관리"),
        "mine_menu_subtitle_pomodoro_focus":
            MessageLookupByLibrary.simpleMessage("포모도로 집중"),
        "mine_menu_subtitle_privacy_permission":
            MessageLookupByLibrary.simpleMessage("개인정보 권한"),
        "mine_menu_subtitle_task_filter":
            MessageLookupByLibrary.simpleMessage("작업 필터"),
        "mine_menu_subtitle_time_record":
            MessageLookupByLibrary.simpleMessage("시간 기록"),
        "mine_menu_subtitle_user_feedback":
            MessageLookupByLibrary.simpleMessage("피드백"),
        "mine_menu_subtitle_voice_record":
            MessageLookupByLibrary.simpleMessage("음성 기록"),
        "mine_menu_subtitle_voice_to_text":
            MessageLookupByLibrary.simpleMessage("음성을 텍스트로"),
        "mine_menu_subtitle_wrong_question_review":
            MessageLookupByLibrary.simpleMessage("오답 정리"),
        ...
        "mobile_voice_task_realtime_fallback":
            MessageLookupByLibrary.simpleMessage(
                "실시간 인식을 사용할 수 없어 녹음 후 인식으로 전환했습니다."),
        "mobile_voice_task_realtime_hint":
            MessageLookupByLibrary.simpleMessage("실시간으로 텍스트를 업데이트 중"),
        "mobile_voice_task_realtime_listening_text":
            MessageLookupByLibrary.simpleMessage("듣는 동안 텍스트로 변환 중입니다"),
        ...
        "modern_poetry": MessageLookupByLibrary.simpleMessage("현대시"),
        "modern_poetry_placeholder":
            MessageLookupByLibrary.simpleMessage("현대시의 주제를 입력하세요..."),
        "modern_poetry_prompt":
            MessageLookupByLibrary.simpleMessage("현대시를 작성해 주세요, 주제는..."),
        ...
        "monthweekday": MessageLookupByLibrary.simpleMessage("월/주/일/3일"),
        "more": MessageLookupByLibrary.simpleMessage("더"),
        "more_lists_and_tasks":
            MessageLookupByLibrary.simpleMessage("더 많은 목록과 작업"),
        "more_lists_and_tasks_description":
            MessageLookupByLibrary.simpleMessage("저장 목록을 카테고리로 분류합니다."),
        "more_prompt":
            MessageLookupByLibrary.simpleMessage("더 많은 글쓰기 옵션을 제공해 주세요."),
        "more_reminders": MessageLookupByLibrary.simpleMessage("더 많은 알림"),
        "more_reminders_description": MessageLookupByLibrary.simpleMessage(
            "중요 이벤트를 놓치지 않도록 5개 이상의 알림을 설정합니다."),
        "more_shared_members":
            MessageLookupByLibrary.simpleMessage("더 많은 공유 멤버"),
        "more_shared_members_description":
            MessageLookupByLibrary.simpleMessage("작업을 멤버에게 할당하고 목록을 공유합니다."),
        ...
        "multi_subtask": MessageLookupByLibrary.simpleMessage("하위 작업"),
        ...
        "never_forget_important":
            MessageLookupByLibrary.simpleMessage("중요한 일을 잊지 마세요"),
        "never_miss_important_things":
            MessageLookupByLibrary.simpleMessage("중요한 일을 절대 놓치지 마세요"),
        "never_miss_review": MessageLookupByLibrary.simpleMessage(
            "리마인더 기능을 사용해 중요한 일정, 예를 들어 티켓 예약과 등록 등을 관리합니다. 지속적인 리마인더 덕분에 중요한 순간을 놓치는 일이 없습니다."),
        "new_card": MessageLookupByLibrary.simpleMessage("새 카드"),
        "new_rich_editor":
            MessageLookupByLibrary.simpleMessage("새로운 리치 텍스트 편집기"),
        "newline": m91,
        "nextMatch": MessageLookupByLibrary.simpleMessage("다음 결과"),
        ...
        "next_month": MessageLookupByLibrary.simpleMessage("다음 달"),
        ...
        "no_focus_ranking_data_today":
            MessageLookupByLibrary.simpleMessage("오늘은 랭킹 데이터가 없습니다"),
        ...
        "no_one_focusing_now":
            MessageLookupByLibrary.simpleMessage("현재 집중 중인 사람이 없습니다"),
        ...
        "no_recording_preview":
            MessageLookupByLibrary.simpleMessage("녹음을 완료하면 미리 들을 수 있습니다"),
        ...
        "normal_user": MessageLookupByLibrary.simpleMessage("일반 사용자"),
        ...
        "objective_final": MessageLookupByLibrary.simpleMessage("목표"),
        ...
        "official_recommendations":
            MessageLookupByLibrary.simpleMessage("공식 추천"),
        ...
        "or_select_quick_amount":
            MessageLookupByLibrary.simpleMessage("빠른 금액 선택"),
        ...
        "persistent_reminders": MessageLookupByLibrary.simpleMessage("지속 알림"),
        ...
        "playback_preview": MessageLookupByLibrary.simpleMessage("2. 재생 미리보기"),
        ...
        "please_input_question":
            MessageLookupByLibrary.simpleMessage("질문을 입력해 주세요"),
        "please_input_search_mission":
            MessageLookupByLibrary.simpleMessage("검색하려는 작업 제목을 입력해 주세요"),
        ...
        "position_order": MessageLookupByLibrary.simpleMessage("위치 순서"),
        "postpone": MessageLookupByLibrary.simpleMessage("오늘로 연기"),
        "practice": MessageLookupByLibrary.simpleMessage("연습"),
        "premium_user": MessageLookupByLibrary.simpleMessage("프리미엄 사용자"),
        "present_value_dialog": m109,
        "press_release": MessageLookupByLibrary.simpleMessage("보도 자료"),
        "press_release_placeholder":
            MessageLookupByLibrary.simpleMessage("보도 자료의 내용 또는 주제를 입력하세요..."),
        "press_release_prompt":
            MessageLookupByLibrary.simpleMessage("보도 자료를 작성해 주세요, 내용은..."),
        ...
        "previousMatch": MessageLookupByLibrary.simpleMessage("이전 결과"),
        "previous_match": MessageLookupByLibrary.simpleMessage("이전 일치"),
        "previous_month": MessageLookupByLibrary.simpleMessage("지난달"),
        ...
        "pros_and_cons": MessageLookupByLibrary.simpleMessage("장단점 목록"),
        "pros_and_cons_placeholder":
            MessageLookupByLibrary.simpleMessage("장단점을 분석할 주제를 입력하세요..."),
        "pros_and_cons_prompt": MessageLookupByLibrary.simpleMessage(
            "어떤 주제에 대한 장단점을 작성해 주세요, 주제는..."),
        "public_course": MessageLookupByLibrary.simpleMessage("공개 훈련 계획"),
        "publish": MessageLookupByLibrary.simpleMessage("게시"),
        "purchase_failed": MessageLookupByLibrary.simpleMessage("구매 실패"),
        "purchase_success": MessageLookupByLibrary.simpleMessage("구매 성공"),
        ...
        "quality_good": MessageLookupByLibrary.simpleMessage("좋음"),
        "quantified_goal": MessageLookupByLibrary.simpleMessage("정량 목표"),
        ...
        "rating_count": MessageLookupByLibrary.simpleMessage("20만+ 평점"),
        "rating_guide":
        ...
        "record_complete": MessageLookupByLibrary.simpleMessage("녹음 완료"),
        "record_device": MessageLookupByLibrary.simpleMessage("녹음 장치"),
        "record_duration": MessageLookupByLibrary.simpleMessage("녹음 시간"),
        "record_satisfied_prompt":
            MessageLookupByLibrary.simpleMessage("이 녹음에 만족하시나요?"),
        "record_time": MessageLookupByLibrary.simpleMessage("녹음 시각"),
        "record_tip_clear":
            MessageLookupByLibrary.simpleMessage("선명한 음성이 더 좋은 결과를 만듭니다"),
        "record_tip_max":
            MessageLookupByLibrary.simpleMessage("놓으면 완료, 최대 10분까지 녹음"),
        "record_tip_replay":
            MessageLookupByLibrary.simpleMessage("녹음 후 미리 듣거나 다시 녹음할 수 있습니다"),
        "record_voice": MessageLookupByLibrary.simpleMessage("음성 녹음"),
        "record_voice_description":
            MessageLookupByLibrary.simpleMessage("생각이나 추가 설명을 음성으로 남기세요"),
        "recording_info": MessageLookupByLibrary.simpleMessage("녹음 정보"),
        "recording_now": MessageLookupByLibrary.simpleMessage("녹음 중..."),
        "recording_paused": MessageLookupByLibrary.simpleMessage("일시 중지됨"),
        "recording_step_title": MessageLookupByLibrary.simpleMessage("1. 녹음 중"),
        ...
        "rerecord": MessageLookupByLibrary.simpleMessage("다시 녹음"),
        "resetToDefaultColor":
        ...
        "restore_failed": MessageLookupByLibrary.simpleMessage("복원 실패"),
        "restore_purchase": MessageLookupByLibrary.simpleMessage("구매 복원"),
        "restore_purchases": MessageLookupByLibrary.simpleMessage("구매 복원"),
        ...
        "revised_text": MessageLookupByLibrary.simpleMessage(
            "수정된 텍스트: 정부는 환경 문제를 해결하기 위해 환경 규제를 강화하고 대중의 인식을 높이며 녹색 에너지를 촉진하고 있습니다."),
        ...
        "rowAddAfter": MessageLookupByLibrary.simpleMessage("다음 행 추가"),
        "rowAddBefore": MessageLookupByLibrary.simpleMessage("이전 행 추가"),
        ...
        "save_img_success": MessageLookupByLibrary.simpleMessage("이미지 저장 성공"),
        "save_mode": MessageLookupByLibrary.simpleMessage("저장 모드"),
        "save_success": MessageLookupByLibrary.simpleMessage("저장 성공"),
        "saving": MessageLookupByLibrary.simpleMessage("저장 중"),
        "saving_img": MessageLookupByLibrary.simpleMessage("이미지를 저장 중"),
        "schedule": MessageLookupByLibrary.simpleMessage("일정"),
        "schedule_management_review": MessageLookupByLibrary.simpleMessage(
            "매일 밤 일간 보기로 다음 날의 일정을 계획하고, 주말에는 주간 보기를 사용하여 한 주간의 시간을 검토합니다. 시간에 대한 명확한 관리로 업무 효율이 향상되고 불안이 줄어들었습니다."),
        "schedule_management_tool":
            MessageLookupByLibrary.simpleMessage("일정 관리 도구"),
        ...
        "select_scenario": MessageLookupByLibrary.simpleMessage(
            "다음 시나리오 중에서 선택하거나 AI에게 편집 방법을 지시하세요"),
        ...
        "share_close": MessageLookupByLibrary.simpleMessage("공유 끄기"),
        "share_open": MessageLookupByLibrary.simpleMessage("공유 켜기"),
        "share_the_link": m117,
        ...
        "simplify_language": MessageLookupByLibrary.simpleMessage("언어 단순화"),
        "simplify_language_prompt": MessageLookupByLibrary.simpleMessage(
            "선택한 단락의 언어를 더 이해하기 쉽게 단순화하세요."),
        ...
        "slashPlaceHolder":
            MessageLookupByLibrary.simpleMessage("/ 입력하여 블록 추가 또는 입력 시작"),
        "slide_left_right":
        ...
        "speech_placeholder":
            MessageLookupByLibrary.simpleMessage("연설의 주제 또는 내용을 입력하세요..."),
        ...
        "start_free_trial": MessageLookupByLibrary.simpleMessage("7일 무료 체험 시작"),
        ...
        "summarize": MessageLookupByLibrary.simpleMessage("요약"),
        "summarize_prompt":
            MessageLookupByLibrary.simpleMessage("선택한 단락의 주요 내용을 요약하세요."),
        ...
        "super_tool": MessageLookupByLibrary.simpleMessage("슈퍼 툴바"),
        ...
        "tap_to_start_recording":
            MessageLookupByLibrary.simpleMessage("눌러서 녹음 시작"),
        ...
        "task_dynamics": MessageLookupByLibrary.simpleMessage("작업 다이나믹스"),
        "task_dynamics_description":
            MessageLookupByLibrary.simpleMessage("각 작업의 수정 기록을 확인합니다."),
        ...
        "time_segment_description":
            MessageLookupByLibrary.simpleMessage("작업의 시작 및 종료 시간을 설정합니다."),
        "time_slots": MessageLookupByLibrary.simpleMessage("시간 슬롯"),
        ...
        "total_value": MessageLookupByLibrary.simpleMessage("총량"),
        ...
        "translate_prompt":
            MessageLookupByLibrary.simpleMessage("선택한 단락을 영어로 번역하세요."),
        "try_again":
        ...
        "turn_off_vibration": MessageLookupByLibrary.simpleMessage("진동 끄기"),
        "turn_on_vibration": MessageLookupByLibrary.simpleMessage("진동 켜기"),
        ...
        "unknown_error": MessageLookupByLibrary.simpleMessage("알 수 없는 오류"),
        ...
        "upgrade_now": MessageLookupByLibrary.simpleMessage("지금 업그레이드"),
        ...
        "upload_more_attachments":
            MessageLookupByLibrary.simpleMessage("더 많은 첨부 파일 업로드"),
        "upload_more_attachments_description":
            MessageLookupByLibrary.simpleMessage(
                "최대 99개의 첨부 파일을 매일 업로드하여 저장 및 참조를 쉽게 할 수 있습니다."),
        ...
        "user_reviews": MessageLookupByLibrary.simpleMessage("사용자 리뷰"),
        ...
        "vip_exclusive":
            MessageLookupByLibrary.simpleMessage("VIP 전용 기능, 샘플 데이터는 참고용입니다"),
        "vip_exclusive_small":
            MessageLookupByLibrary.simpleMessage("VIP 전용 기능"),
        ...
        "write_essay_placeholder":
            MessageLookupByLibrary.simpleMessage("에세이의 제목 또는 주제를 입력하세요..."),
        "write_essay_prompt":
