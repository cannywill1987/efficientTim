...
//        }
            ...
            AppWidgetManager.getInstance(context).updateAppWidget(new ComponentName(context, MyNoteWidgetProvider.class), Utility.getMyNoteView(context, "1"));
        }
...
//        appWidgetManager.updateAppWidget(appWidgetIds, remoteViews);//用updateAppWidget来更新remoteViews的状态
    ...
    private void onWidgetUpdate(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        RemoteViews remoteViews = Utility.getMyNoteView(context, "1");
