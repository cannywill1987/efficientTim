...
public final class FileUtil {
	 ...
	 */
	public static void writeDataToFile(final String data, final String path, final String unio, final boolean append) throws IOException {
	 ...
	 * @return 如果文件及路径不存在将创建文件
	 */
	public static boolean write(final String fileFullPath, final byte[] pBuf, final int pos, final int size, final int skip) {
	...
	/**
	 * 删除指定目录下所有文件 .
	 * @author wangguanwen 2015年1月22日 上午11:39:14 <br> 
	 * @param root 
	 */
