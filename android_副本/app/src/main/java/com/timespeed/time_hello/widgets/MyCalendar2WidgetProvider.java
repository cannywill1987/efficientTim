...
public class MyCalendar2WidgetProvider extends AppWidgetProvider {
...
//        AppWidgetManager appWidgetManager = AppWidgetManager.getInstance(context);
        if (AppWidgetManager.ACTION_APPWIDGET_DELETED.equals(action)) {
            ...
            AppWidgetManager.getInstance(context).updateAppWidget(new ComponentName(context, MyCalendar2WidgetProvider.class), Utility.getMyCalendarRemoteViews2(context, System.currentTimeMillis()));
        }
...
//        appWidgetManager.updateAppWidget(appWidgetIds, remoteViews);//用updateAppWidget来更新remoteViews的状态
    ...
    private void onWidgetUpdate(Context context, AppWidgetManager appWidgetManager, int appWidgetId) {
        RemoteViews remoteViews = Utility.getMyCalendarRemoteViews2(context, System.currentTimeMillis());
