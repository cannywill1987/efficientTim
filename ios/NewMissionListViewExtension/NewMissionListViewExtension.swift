//
//  NewMissionListViewExtension.swift
...
struct NewMissionListViewExtensionEntryView : View {
...
struct NewMissionListViewExtension: Widget {
    let kind: String = "NewMissionListViewExtension"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            if #available(iOS 17.0, *) {
                NewMissionListViewExtensionEntryView(entry: entry)
