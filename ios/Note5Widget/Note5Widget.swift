...
struct Provider: TimelineProvider {
    @AppStorage("WQBMissionStoreDataNote5", store: UserDefaults(suiteName: "group.com.timespeed.timehello")) var primaryData : Data = Data()
...
struct Note5WidgetEntryView : View {
...
@main
struct Note5Widget: Widget {
    let kind: String = "NoteWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            Note5WidgetEntryView(entry: entry)
        }
