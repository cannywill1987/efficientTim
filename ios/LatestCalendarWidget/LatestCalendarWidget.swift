//
//  LatestCalendarWidget.swift
//  LatestCalendarWidget
//
//  Created by 林智彬 on 2024/11/1.
//
...
struct LatestCalendarWidgetEntryView : View {
...
struct LatestCalendarWidget: Widget {
    let kind: String = "LatestCalendarWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            if #available(iOS 17.0, *) {
                LatestCalendarWidgetEntryView(entry: entry)
