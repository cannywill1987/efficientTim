...
struct Provider: TimelineProvider {
    @AppStorage("WQBMissionStoreDataNote6", store: UserDefaults(suiteName: "group.com.timespeed.timehello")) var primaryData : Data = Data()
...
struct Note6WidgetEntryView : View {
...
@main
struct Note6Widget: Widget {
    let kind: String = "NoteWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            Note6WidgetEntryView(entry: entry)
        }
