...
struct Provider: TimelineProvider {
    @AppStorage("WQBMissionStoreDataNote7", store: UserDefaults(suiteName: Params.groupName)) var primaryData : Data = Data()
...
struct LatestNote7WidgetEntryView : View {
...
struct LatestNote7Widget: Widget {
    let kind: String = "LatestNote1Widget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            if #available(iOS 17.0, *) {
                LatestNote7WidgetEntryView(entry: entry)
