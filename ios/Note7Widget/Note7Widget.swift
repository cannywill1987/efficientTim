...
struct Provider: TimelineProvider {
    @AppStorage("WQBMissionStoreDataNote7", store: UserDefaults(suiteName: "group.com.timespeed.timehello")) var primaryData : Data = Data()
...
struct Note7WidgetEntryView : View {
...
@main
struct Note7Widget: Widget {
    let kind: String = "NoteWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            Note7WidgetEntryView(entry: entry)
        }
