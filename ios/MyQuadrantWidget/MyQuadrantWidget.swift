//
//  MyQuadrantWidget.swift
//  MyQuadrantWidget
//
//  Created by 林智彬 on 2023/9/2.
//
...
struct MyQuadrantWidgetEntryView : View {
...
@main
struct MyQuadrantWidget: Widget {
    let kind: String = "MyQuadrantWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            MyQuadrantWidgetEntryView(entry: entry)
        }
...
struct MyQuadrantWidget_Previews: PreviewProvider {
    static var previews: some View {
        ...
        MyQuadrantWidgetEntryView(entry: SimpleEntry(date: Date(), storeData: storeData))
