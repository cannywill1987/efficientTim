...
struct NewClockInWidgetEntryView : View {
...
struct NewClockInWidget: Widget {
    let kind: String = "NewClockInWidget"

    var body: some WidgetConfiguration {
        StaticConfiguration(kind: kind, provider: Provider()) { entry in
            if #available(iOS 17.0, *) {
                NewClockInWidgetEntryView(entry: entry)
