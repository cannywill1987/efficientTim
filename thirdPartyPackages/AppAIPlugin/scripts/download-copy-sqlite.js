...
const { execCmdSync } = require("./util");
...
async function installAndCopySqlite(target) {
  ...
  rimrafSync("../libs/core/node_modules/sqlite3/build");
  await downloadSqlite(target, "../libs/core/node_modules/sqlite3/build.tar.gz");
  execCmdSync(
    "cd ../libs/core/node_modules/sqlite3 && tar -xvzf build.tar.gz",
  );
  fs.unlinkSync("../libs/core/node_modules/sqlite3/build.tar.gz");
}
