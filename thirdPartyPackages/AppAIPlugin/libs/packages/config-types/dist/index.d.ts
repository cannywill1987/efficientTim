...
export declare const modelDescriptionSchema: z.ZodObject<{
    title: z.ZodString;
    provider: z.ZodEnum<["openai", "anthropic", "cohere", "ollama", "huggingface-tgi", "huggingface-inference-api", "replicate", "gemini", "mistral", "bedrock", "sagemaker", "cloudflare", "azure", "ovhcloud", "continue-proxy", "nebius", "scaleway", "watsonx", "minimax"]>;
    model: z.ZodString;
    ...
    title: string;
    provider: "openai" | "anthropic" | "cohere" | "ollama" | "huggingface-tgi" | "huggingface-inference-api" | "replicate" | "gemini" | "mistral" | "bedrock" | "sagemaker" | "cloudflare" | "azure" | "ovhcloud" | "continue-proxy" | "nebius" | "scaleway" | "watsonx" | "minimax";
    model: string;
