...
import { convertVercelStream, convertVercelStreamPart, } from "../vercelStreamConverter.js";
...
describe("convertVercelStream", () => {
    ...
    test("converts stream of mixed events", async () => {
        ...
        expect(chunks[3].choices[0].delta.tool_calls?.[0].function?.arguments).toBe('{"arg":"value"}');
