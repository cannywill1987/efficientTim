...
describe("AskSage Adapter Tests", () => {
    ...
    test("completionNonStream should throw not supported error", async () => {
        ...
        expect(() => api.completionNonStream({
            model: "gpt-4o",
            prompt: "Hello",
        }, new AbortController().signal)).toThrow("AskSage does not support legacy completions API");
    });
...
//# sourceMappingURL=asksage-adapter.vitest.js.map