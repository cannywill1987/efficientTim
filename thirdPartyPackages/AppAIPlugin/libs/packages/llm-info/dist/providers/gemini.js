...
export const Gemini = {
    models: [
        // Gemini 3.1 series
        {
            ...
            description: "Google's most capable model with 2M context window and high precision multimodal capabilities.",
        ...
        },
        {
            ...
            description: "Cost-efficient model optimized for high-volume tasks with fast inference.",
        ...
        // Gemini 3 series
        {
            ...
            description: "High-speed thinking model for agentic workflows, multi-turn chat, and coding.",
            contextLength: 1048576,
            maxCompletionTokens: 65536,
            mediaTypes: AllMediaTypes,
        ...
        },
        {
            ...
            description: "Lightweight, fast model optimized for low-latency tasks with 1M context window",
            contextLength: 1048576,
            maxCompletionTokens: 65536,
            mediaTypes: AllMediaTypes,
