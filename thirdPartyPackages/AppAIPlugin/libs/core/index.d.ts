...
export interface IDE {
  ...
  gotoTypeDefinition(location: Location): Promise<RangeInFile[]>; // TODO: add to Flutter host
  getSignatureHelp(location: Location): Promise<SignatureHelp | null>; // TODO: add to Flutter host
