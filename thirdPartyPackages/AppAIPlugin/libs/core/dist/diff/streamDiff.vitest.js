...
async function collectDiffs(oldLines, newLines) {
    const streamDiffs = [];
...
function getMyersDiffType(diff) {
...
describe("streamDiff(", () => {
    ...
    test.each([false, true])("ignores indentation changes for sufficiently long lines (trailingWhitespace: %s)", async (trailingWhitespace) => {
        let oldLines = [
            " short",
            "   middle",
            " a long enough line",
