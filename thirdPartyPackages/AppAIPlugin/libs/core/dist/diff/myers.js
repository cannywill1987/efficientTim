...
export function convertMyersChangeToDiffLines(change) {
...
export function myersDiff(oldContent, newContent) {
...
export function myersCharDiff(oldContent, newContent) {
