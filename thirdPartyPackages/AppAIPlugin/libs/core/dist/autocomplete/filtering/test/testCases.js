...
export const TEST_CASES_WITH_DIFF = [
    {
...
`,
    ...
    {
        description: "Should autocomplete a Markdown heading and preserve formatting",
        filename: "test.md",
        input: `# My Document
...
`,
  ...
  "skills": {
    ...
    {
        description: "Should return nothing when output is duplicated lines in TypeScript",
        filename: "file.ts",
        input: `
...
`,
    ...
    {
        description: "Should return partial result when output is duplicated lines in TypeScript",
        filename: "file.ts",
        input: `
async getContextForPath(
    filepath: string,
...
`,
    ...
    {
        description: "Should complete YAML key-value pair inside a nested structure",
        filename: "test.yaml",
        input: `
      version: '3'
      services:
    ...
    {
        description: "Should autocomplete SQL query with subquery and alias in SELECT clause",
...
export const TEST_CASES_WITHOUT_DIFF = [
    {
    ...
    {
        description: "Should preserve closing brackets when the opening bracket is not a part of the completion.",
        filename: "test.js",
        input: dedent `
      class Calculator {
        constructor() {
...
`,
    ...
    {
        description: "Should complete a CSS rule when the property is partially typed",
        filename: "styles.css",
        input: `
button {
...
func calculateArea<|fim|>`,
    ...
    {
        description: "Should handle autocomplete in the middle of a Go struct definition",
...
func main() {
    ...
    {
        description: "Should autocomplete SQL query with nested functions and missing bracket",
    ...
    {
        description: "Should autocomplete SQL script with employee and product tables",
  ...
  `,
    ...
    {
        description: "Should autocomplete multi-line SQL query with CASE statements",
...
public class App {
    ...
    {
        description: "Should autocomplete a C++ class definition with a constructor",
        filename: "test.cpp",
    ...
    },
    {
        ...
        filename: "test.cpp",
        input: "class Calculator { public: int add(int a, int b); int subtract(int a, int b);<|fim|> };",
...
Jane Smith<|fim|>`,
    ...
    {
        description: "Should complete CSV record when starting in the middle of a word",
        filename: "test.csv",
...
2, B<|fim|>`,
    ...
    {
        description: "Should autocomplete a Rust function implementation inside a struct",
        filename: "main.rs",
        input: `
struct Calculator {
    result: f64,
...
class Counter {
  ...
  void reset() {
    ...
    {
        description: "Should autocomplete Clojure function definition with missing closing parenthesis",
  ...
  (let [sum (+ a b)]
    ...
    {
        description: "Should autocomplete missing part of a Clojure map within a function",
        input: `(defn get-user []
  {:username "johndoe"
  ...
  (println "User information loaded"))`,
    ...
    {
        description: "Should autocomplete inside a Clojure vector within a looping construct",
...
data class User(
    ...
    {
        description: "Should complete Kotlin if-else structure with missing brackets",
...
interface AutocompleteCodeSnippet`,
  ...
  filepath: string;
    ...
    {
        description: "Should autocomplete a TypeScript arrow function inside a variable assignment",
...
`,
    ...
    //   },
    {
        description: "Should autocomplete a C# class with a constructor and property",
        filename: "Person.cs",
        input: `using System;
...
let oddSquares = [<|fim|>]`,
  ...
  &:hover {
    ...
    {
        description: "Should autocomplete SCSS variable in the middle of a statement",
        filename: "styles.scss",
...
`,
    ...
    {
        description: "Should handle autocomplete in two similar TypeScript functions",
        filename: "List.svelte",
        input: `
