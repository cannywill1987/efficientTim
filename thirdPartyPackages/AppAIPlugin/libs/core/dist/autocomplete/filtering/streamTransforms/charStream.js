 ...
 */
export async function* onlyWhitespaceAfterEndOfLine(stream, endOfLine, fullStop) {
    let pending = "";
 ...
 */
export async function* noFirstCharNewline(stream) {
    let first = true;
 ...
 */
export async function* stopAtStopTokens(stream, stopTokens) {
 ...
 */
export async function* stopAtStartOf(stream, suffix, sequenceLength = 20) {
