...
export function formatOpenedFilesContext(recentlyOpenedFilesSnippets, remainingTokenCount, helper, alreadyAddedSnippets, TOKEN_BUFFER) {
...
function trimSnippetForContext(snippet, maxTokens, modelName) {
    ...
    let trimmedCode = pruneStringFromBottom(modelName, maxTokens, snippet.content);
    return {
