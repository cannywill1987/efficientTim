export declare enum AutocompleteSnippetType {
    Code = "code",
    Diff = "diff",
    Clipboard = "clipboard",
    Static = "static"
...
export type AutocompleteSnippet = AutocompleteCodeSnippet | AutocompleteDiffSnippet | AutocompleteClipboardSnippet | AutocompleteStaticSnippet;
export {};
