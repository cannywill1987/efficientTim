...
import { extractFunctionTypeFromDecl, extractTopLevelDecls, findEnclosingTypeDeclaration, unwrapToBaseType, } from "./tree-sitter-utils";
export class StaticContextService {
    ...
    currentFile, foundContents) {
        if (!foundSoFar.has(typeName)) {
            ...
            const query = await getQueryForFile(currentFile, `static-context-queries/relevant-types-queries/${language}-extract-identifiers.scm`);
            if (!query) {
