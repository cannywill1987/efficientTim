export function safeParseToolCallArgs(toolCall) {
...
export function getStringArg(args, argName, allowEmpty = false) {
...
export function getOptionalStringArg(args, argName, allowEmpty = false) {
    if (typeof args?.[argName] === "undefined") {
        return undefined;
    }
    return getStringArg(args, argName, allowEmpty);
}
export function getNumberArg(args, argName) {
    if (!args || !(argName in args)) {
...
export function getBooleanArg(args, argName, required = false) {
    if (!args || !(argName in args)) {
        if (required) {
