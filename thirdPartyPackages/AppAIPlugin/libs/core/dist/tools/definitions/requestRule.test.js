...
describe("getRequestRuleDescription", () => {
    it("should return no rules message when no agent-requested rules exist", () => {
        ...
        expect(result).toBe("Use this tool to retrieve additional 'rules' that contain more context/instructions based on their descriptions. Available rules:\n" +
            "No rules available.");
    });
    it("should return formatted rules when agent-requested rules exist", () => {
        ...
        const result = getRequestRuleDescription(rules);
        const expected = "Use this tool to retrieve additional 'rules' that contain more context/instructions based on their descriptions. Available rules:\n" +
