...
import { coerceArgsToSchema, getBooleanArg, getNumberArg, getOptionalStringArg, getStringArg, safeParseToolCallArgs, } from "./parseArgs";
...
describe("getStringArg", () => {
    ...
    it("should throw error when argument is missing", () => {
        ...
        expect(() => getStringArg(args, "name")).toThrowError("`name` argument is required and must not be empty or whitespace-only. (type string)");
    });
    ...
    it("should throw error when argument is empty and empty not allowed", () => {
        const args = { name: "" };
        expect(() => getStringArg(args, "name")).toThrowError("Argument name must not be empty or whitespace-only");
        const argsWithSpace = { name: "   " };
        expect(() => getStringArg(argsWithSpace, "name")).toThrowError("Argument name must not be empty or whitespace-only");
    });
    ...
    it("should handle null or undefined args", () => {
        expect(() => getStringArg(null, "name")).toThrowError("`name` argument is required and must not be empty or whitespace-only. (type string)");
        expect(() => getStringArg(undefined, "name")).toThrowError("`name` argument is required and must not be empty or whitespace-only. (type string)");
    });
    ...
    it("should convert nested JSON object to string for contents parameter", () => {
        ...
        const result = getStringArg(args, "contents");
        const expected = '{"user":{"name":"John","details":{"age":30,"preferences":["coding","reading"]}}}';
    ...
    it("should handle contents parameter that is null", () => {
        ...
        expect(() => getStringArg(args, "contents")).toThrowError("`contents` argument is required and must not be empty or whitespace-only. (type string)");
    });
});
describe("getOptionalStringArg", () => {
    ...
    it("should throw error when argument is not a string", () => {
        const args = { name: 123 };
        expect(() => getOptionalStringArg(args, "name")).toThrowError("`name` argument is required and must not be empty or whitespace-only. (type string)");
    });
    it("should throw error when argument is empty and empty not allowed", () => {
        const args = { name: "" };
        expect(() => getOptionalStringArg(args, "name")).toThrowError("Argument name must not be empty or whitespace-only");
    });
    it("should accept empty string when allowEmpty is true", () => {
        const args = { name: "" };
...
describe("getBooleanArg", () => {
    ...
    it("should throw error when argument is not provided and required", () => {
        const args = { otherArg: true };
        expect(() => getBooleanArg(args, "flag", true)).toThrowError("Argument `flag` is required (type boolean)");
    });
    ...
    it("should throw error when argument is not a boolean or valid boolean string", () => {
        ...
        expect(() => getBooleanArg(argsNumber, "flag")).toThrowError("Argument `flag` must be a boolean true or false");
        expect(() => getBooleanArg(argsInvalidString, "flag")).toThrowError("Argument `flag` must be a boolean true or false");
        expect(() => getBooleanArg(argsObject, "flag")).toThrowError("Argument `flag` must be a boolean true or false");
    });
    it("should handle null or undefined args", () => {
        expect(getBooleanArg(null, "flag")).toBeUndefined();
        expect(getBooleanArg(undefined, "flag")).toBeUndefined();
        expect(() => getBooleanArg(null, "flag", true)).toThrowError("Argument `flag` is required (type boolean)");
        expect(() => getBooleanArg(undefined, "flag", true)).toThrowError("Argument `flag` is required (type boolean)");
    });
});
...
describe("getNumberArg", () => {
    ...
    it("should throw error when argument is missing", () => {
        ...
        expect(() => getNumberArg(args, "count")).toThrowError("Argument `count` is required (type number)");
    });
    it("should throw error when argument is not a number", () => {
        ...
        expect(() => getNumberArg(argsString, "count")).toThrowError("Argument `count` must be a valid number");
        expect(() => getNumberArg(argsBoolean, "count")).toThrowError("Argument `count` must be a valid number");
        expect(() => getNumberArg(argsObject, "count")).toThrowError("Argument `count` must be a valid number");
    });
    it("should throw error when argument is NaN", () => {
        const args = { count: NaN };
        expect(() => getNumberArg(args, "count")).toThrowError("Argument `count` must be a valid number");
    });
    ...
    it("should handle null or undefined args", () => {
        expect(() => getNumberArg(null, "count")).toThrowError("Argument `count` is required (type number)");
        expect(() => getNumberArg(undefined, "count")).toThrowError("Argument `count` is required (type number)");
    });
});
