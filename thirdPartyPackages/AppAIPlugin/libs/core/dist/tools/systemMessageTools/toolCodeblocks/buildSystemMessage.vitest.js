...
import { TOOL_INSTRUCTIONS_TAG, addSystemMessageToolsToSystemMessage, generateToolsSystemMessage, } from "../buildToolsSystemMessage";
...
describe("createSystemMessageExampleCall", () => {
    it("creates a system message example call with no args", () => {
        const result = framework.createSystemMessageExampleCall("test_tool", "Use this tool to test things");
    ...
    it("handles multiline arg values correctly", () => {
        ...
        const result = framework.createSystemMessageExampleCall("test_tool", "Use this tool to test things", [["arg1", multilineValue]]);
        expect(result).includes("BEGIN_ARG: arg1");
...
describe("generateToolsSystemMessage", () => {
    ...
    it("generates system message for tools with system message descriptions", () => {
        const customDescription = "This is test tool 1's system message description";
        const tools = [
            {
                function: {
                    name: "test_tool1",
    ...
    it("handles tools with and without system message descriptions", () => {
        ...
        expect(result.match(/TOOL_NAME: tool_with_description/g)?.length ?? 0).toBe(1);
    });
...
describe("addSystemMessageToolsToSystemMessage", () => {
    it("returns original system message when no tools are provided", () => {
        ...
        const result = addSystemMessageToolsToSystemMessage(framework, baseMessage, []);
    ...
    it("appends tools system message to base message", () => {
        ...
        const result = addSystemMessageToolsToSystemMessage(framework, baseMessage, tools);
