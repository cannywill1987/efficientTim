...
describe("executeFindAndReplace", () => {
    describe("normal cases", () => {
        ...
        it("should replace single occurrence when replaceAll is false", () => {
            const content = "Hello world\nHello again";
            const result = executeFindAndReplace(content, "Hello world", "Hi world", false);
            expect(result).toBe("Hi world\nHello again");
        });
        ...
        it("should preserve whitespace and indentation", () => {
            ...
            const result = executeFindAndReplace(content, "    const value = 'old';", "    const value = 'new';", false);
            expect(result).toBe("function test() {\n    const value = 'new';\n    return value;\n}");
        });
        it("should handle multiline strings", () => {
            const content = "line1\nline2\nline3";
            const result = executeFindAndReplace(content, "line1\nline2", "newline1\nnewline2", false);
    ...
    describe("indentation adjustment", () => {
        it("should adjust indentation when trimmedMatch finds unindented old_string in indented file", () => {
            ...
            const result = executeFindAndReplace(fileContent, oldString, newString, false);
    ...
    describe("edge cases", () => {
        ...
        it("should handle entire content replacement", () => {
            ...
            const result = executeFindAndReplace(content, "replace everything", "new content", false);
