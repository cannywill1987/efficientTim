...
export function getReplacementByMatching(oldCode, linesBefore, linesAfter) {
...
export async function* getReplacementWithLlm(oldCode, linesBefore, linesAfter, llm, abortController) {
