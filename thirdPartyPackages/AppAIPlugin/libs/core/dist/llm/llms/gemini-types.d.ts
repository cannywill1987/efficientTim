...
export declare function convertContinueToolToGeminiFunction(tool: Tool): GeminiToolFunctionDeclaration;
...
export declare function mergeConsecutiveGeminiMessages(contents: GeminiChatContent[]): GeminiChatContent[];
export {};
