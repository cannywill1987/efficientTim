...
export async function llmFromDescription(desc, readFile, getUriFromPath, uniqueId, ideSettings, llmLogger, completionOptions) {
    ...
    if (desc.systemMessage !== undefined) {
        ...
        baseChatSystemMessage = await renderTemplatedString(Handlebars, desc.systemMessage, {}, [], readFile, getUriFromPath);
    }
    let options = {
        ...desc,
        completionOptions: {
...
export function llmFromProviderAndOptions(providerName, llmOptions) {
