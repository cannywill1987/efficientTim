import { anthropicTemplateMessages, chatmlTemplateMessages, codeLlama70bTemplateMessages, deepseekTemplateMessages, gemmaTemplateMessage, graniteTemplateMessages, llama2TemplateMessages, llama3TemplateMessages, llavaTemplateMessages, neuralChatTemplateMessages, openchatTemplateMessages, phi2TemplateMessages, phindTemplateMessages, templateAlpacaMessages, xWinCoderTemplateMessages, zephyrTemplateMessages, } from "./chat.js";
  ...
  Hello [/INST]Hi there!</s><s>[INST] How are you? [/INST]`;
    ...
    describe("llavaTemplateMessages", () => {
        it("should generate the correct prompt with user messages", () => {
            ...
            const expectedPrompt = "A chat between a curious user and an artificial intelligence assistant. The assistant gives helpful, detailed, and polite answers to the user's questions.USER: <image>Describe this image.ASSISTANT: ";
            expect(prompt).toBe(expectedPrompt);
        });
    });
    ...
    describe("templateAlpacaMessages", () => {
        it("should generate the correct prompt with user message", () => {
            ...
            const expectedPrompt = "Below is an instruction that describes a task. Write a response that appropriately completes the request.\n\n### Instruction:\nExplain recursion.\n\n### Response:\n";
            expect(prompt).toBe(expectedPrompt);
        });
    });
    ...
    describe("openchatTemplateMessages", () => {
        it("should generate the correct prompt with user and assistant messages", () => {
            ...
            const expectedPrompt = "GPT4 Correct User: Hello<|end_of_turn|>GPT4 Correct Assistant: Hi!<|end_of_turn|>GPT4 Correct User: How are you?<|end_of_turn|>GPT4 Correct Assistant:";
            expect(prompt).toBe(expectedPrompt);
        });
    });
