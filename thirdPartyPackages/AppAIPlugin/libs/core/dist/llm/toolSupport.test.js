...
describe("PROVIDER_TOOL_SUPPORT", () => {
    describe("continue-proxy", () => {
        ...
        it("should return true for Claude 3.5 models", () => {
            expect(supportsFn("ownerSlug/packageSlug/anthropic/claude-3-5-sonnet")).toBe(true);
            expect(supportsFn("ownerSlug/packageSlug/anthropic/claude-3.5-sonnet")).toBe(true);
        });
        it("should return true for Claude 3.7 models", () => {
            expect(supportsFn("ownerSlug/packageSlug/anthropic/claude-3-7-haiku")).toBe(true);
            expect(supportsFn("ownerSlug/packageSlug/anthropic/claude-3.7-sonnet")).toBe(true);
        });
        it("should return true for GPT-4 models", () => {
            expect(supportsFn("ownerSlug/packageSlug/openai/gpt-4-turbo")).toBe(true);
            expect(supportsFn("ownerSlug/packageSlug/openai/gpt-4-1106-preview")).toBe(true);
        });
        ...
        it("should return true for Gemini models", () => {
            ...
            expect(supportsFn("ownerSlug/packageSlug/gemini/gemini-2.5-pro")).toBe(true);
        });
        it("should return false for unsupported models", () => {
            expect(supportsFn("ownerSlug/packageSlug/openai/gpt-3.5-turbo")).toBe(false);
            expect(supportsFn("ownerSlug/packageSlug/anthropic/claude-2")).toBe(false);
