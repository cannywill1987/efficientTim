import { BlockType, ConfigResult, DevDataLogEvent, ModelRole } from "@continuedev/config-yaml";
...
import { BaseSessionMetadata, BrowserSerializedContinueConfig, ChatMessage, CompiledMessagesResult, CompleteOnboardingPayload, ContextItem, ContextItemWithId, ContextSubmenuItem, DiffLine, DocsIndexingDetails, ExperimentalModelRoles, FileSymbolMap, IdeSettings, LLMFullCompletionOptions, McpUiState, MessageOption, ModelDescription, PromptLog, RangeInFile, RangeInFileWithNextEditInfo, SerializedContinueConfig, Session, SiteIndexingConfig, SlashCommandDescWithSource, StreamDiffLinesPayload, ToolCall } from "../";
...
import { ControlPlaneEnv, ControlPlaneSessionInfo } from "../control-plane/AuthTypes";
...
export type ToCoreFromIdeOrWebviewProtocol = {
    ...
    "config/addGlobalRule": [undefined | {
        baseFilename?: string;
    }, void];
    "config/deleteRule": [{
        filepath: string;
