...
export function addModel(model, role) {
...
export function deleteModel(title) {
    editConfigFile((config) => {
...
export function getModelByRole(config, role) {
 ...
 */
export function isSupportedLanceDbCpuTargetForLinux(ide) {
 ...
 * @returns
 */
export function serializePromptTemplates(templates) {
    if (!templates)
        return undefined;
