...
export class PreTrainedTokenizer extends PreTrainedTokenizer_base {
    ...
    _warned_about_chat_template: boolean | undefined;
    /**
...
export class WhisperTokenizer extends PreTrainedTokenizer {
    ...
    _decode_asr(sequences: Array<{
        ...
        stride: number[];
    }>, { return_timestamps, return_language, time_precision, force_full_sequences, }?: Object): Array<string | {
    ...
    get_decoder_prompt_ids({ language, task, no_timestamps, }?: {
        ...
        no_timestamps?: boolean | undefined;
    }): number[][];
}
...
declare class PreTokenizer extends PreTokenizer_base {
     ...
     */
    pre_tokenize(text: string | string[], options?: Object): string[];
    /**
     ...
     * @returns {string[]} An array of pre-tokens.
     */
    _call(text: string | string[], options?: Object): string[];
}
