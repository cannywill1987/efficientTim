...
export class PreTrainedModel extends PreTrainedModel_base {
    ...
    _runBeam: typeof decoderRunBeam | typeof seq2seqRunBeam | null;
    _getStartBeams: typeof decoderStartBeams | typeof seq2seqStartBeams | null;
    _updateBeam: typeof decoderUpdatebeam | null;
     ...
     */
    _call(model_inputs: Object): Promise<Object>;
    /**
     ...
     */
    generate(inputs: Tensor | any[] | import("./utils/maths.js").TypedArray, generation_config?: Object | (new (kwargs?: import("./utils/generation.js").GenerationConfigType) => import("./utils/generation.js").GenerationConfigType) | null, logits_processor?: Object | null, { inputs_attention_mask }?: {
        inputs_attention_mask?: Object | undefined;
    }): Promise<number[][] | {
        sequences: Tensor;
     ...
     */
    getPastKeyValues(decoderResults: Object, pastKeyValues: Object): Object;
    /**
     ...
     */
    getAttentions(decoderResults: Object): Object;
    /**
     ...
     */
    addPastKeyValues(decoderFeeds: Object, pastKeyValues: Object): void;
    /**
...
export class BaseModelOutput extends ModelOutput {
    ...
    constructor({ last_hidden_state, hidden_states, attentions }: {
        ...
        hidden_states?: Tensor | undefined;
...
export class BertForMaskedLM extends BertPreTrainedModel {
     ...
     */
    _call(model_inputs: Object): Promise<MaskedLMOutput>;
}
/**
...
export class BertForTokenClassification extends BertPreTrainedModel {
     ...
     */
    _call(model_inputs: Object): Promise<TokenClassifierOutput>;
}
/**
...
export class BertForQuestionAnswering extends BertPreTrainedModel {
     ...
     */
    _call(model_inputs: Object): Promise<QuestionAnsweringModelOutput>;
}
...
export class T5ForConditionalGeneration extends T5PreTrainedModel {
     ...
     */
    constructor(config: Object, session: any, decoder_merged_session: any, generation_config: new (kwargs?: import("./utils/generation.js").GenerationConfigType) => import("./utils/generation.js").GenerationConfigType);
...
export class MBartForCausalLM extends MBartPreTrainedModel {
     ...
     */
    constructor(config: Object, decoder_merged_session: Object, generation_config: Object);
    generation_config: Object;
    num_decoder_layers: any;
    num_decoder_heads: any;
    decoder_dim_kv: number;
...
export class WhisperForConditionalGeneration extends WhisperPreTrainedModel {
     ...
     */
    generate(inputs: Object, generation_config?: Object, logits_processor?: Object): Promise<Object>;
    /**
...
export class VisionEncoderDecoderModel extends PreTrainedModel {
     ...
     * @param {Object} generation_config Configuration object for the generation process.
     */
    constructor(config: Object, session: Object, decoder_merged_session: any, generation_config: Object);
    decoder_merged_session: any;
    generation_config: Object;
...
export class GPT2PreTrainedModel extends PreTrainedModel {
     ...
     * @param {GenerationConfig} generation_config The generation configuration.
     */
    constructor(config: Object, session: any, generation_config: new (kwargs?: import("./utils/generation.js").GenerationConfigType) => import("./utils/generation.js").GenerationConfigType);
    generation_config: new (kwargs?: import("./utils/generation.js").GenerationConfigType) => import("./utils/generation.js").GenerationConfigType;
    num_heads: any;
    num_layers: any;
    dim_kv: number;
...
export class CodeGenPreTrainedModel extends PreTrainedModel {
     ...
     * @param {GenerationConfig} generation_config The generation configuration.
     */
    constructor(config: Object, session: Object, generation_config: new (kwargs?: import("./utils/generation.js").GenerationConfigType) => import("./utils/generation.js").GenerationConfigType);
    generation_config: new (kwargs?: import("./utils/generation.js").GenerationConfigType) => import("./utils/generation.js").GenerationConfigType;
    num_heads: any;
    num_layers: any;
    dim_kv: number;
...
export class DetrForSegmentation extends DetrPreTrainedModel {
     ...
     */
    _call(model_inputs: Object): Promise<DetrSegmentationOutput>;
}
...
export class SamModel extends SamPreTrainedModel {
     ...
     */
    constructor(config: Object, vision_encoder: Object, prompt_encoder_mask_decoder: any);
    ...
    forward(model_inputs: {
         ...
         * - `-10`: the point is a padding point, thus should be ignored by the prompt encoder
         */
        input_labels?: Tensor | undefined;
        /**
         * Image embeddings used by the mask decoder.
         */
        image_embeddings?: Tensor | undefined;
        /**
         * Image positional embeddings used by the mask decoder.
         */
        image_positional_embeddings?: Tensor | undefined;
    }): Promise<Object>;
    /**
     * Runs the model with the provided inputs
     * @param {Object} model_inputs Model inputs
     ...
     */
    _call(model_inputs: Object): Promise<SamImageSegmentationOutput>;
}
/**
...
export class SpeechT5ForTextToSpeech extends SpeechT5PreTrainedModel {
    ...
    generate_speech(input_values: Tensor, speaker_embeddings: Tensor, { threshold, minlenratio, maxlenratio, vocoder, }?: {
        ...
        minlenratio?: number | undefined;
        maxlenratio?: number | undefined;
        vocoder?: Object | undefined;
        output_cross_attentions?: boolean | undefined;
    }): Promise<{
        /**
         * The predicted log-mel spectrogram of shape
         * `(output_sequence_length, config.num_mel_bins)`. Returned when no `vocoder` is provided
         */
        spectrogram?: Tensor | undefined;
        /**
         * The predicted waveform of shape `(num_frames,)`. Returned when a `vocoder` is provided.
         */
        waveform?: Tensor | undefined;
        /**
         * The outputs of the decoder's cross-attention layers of shape
         * `(config.decoder_layers, config.decoder_attention_heads, output_sequence_length, input_sequence_length)`. returned when `output_cross_attentions` is `true`.
         */
        cross_attentions?: Tensor | undefined;
    }>;
}
/**
 * HiFi-GAN vocoder.
...
export class VitsModel extends VitsPreTrainedModel {
     ...
     */
    _call(model_inputs: Object): Promise<VitsModelOutput>;
}
...
export class PretrainedMixin {
     ...
     */
    static MODEL_CLASS_MAPPINGS: Map<string, Object>[];
    /**
...
export class AutoModelForSeq2SeqLM extends PretrainedMixin {
    static MODEL_CLASS_MAPPINGS: Map<string, (string | typeof T5ForConditionalGeneration)[] | (string | typeof MarianMTModel)[]>[];
}
/**
...
export class Seq2SeqLMOutput extends ModelOutput {
    ...
    constructor({ logits, past_key_values, encoder_outputs, decoder_attentions, cross_attentions, }: {
        ...
        decoder_attentions?: Tensor | undefined;
        cross_attentions?: Tensor | undefined;
    });
    logits: Tensor;
    past_key_values: Tensor;
 ...
 * @private
 */
declare function decoderRunBeam(self: Object, beam: {
    input: Tensor;
    model_input_ids: Tensor;
    attention_mask: Tensor;
    prev_model_outputs: Object;
 ...
 * @private
 */
declare function seq2seqRunBeam(self: PreTrainedModel, beam: Object): Promise<Object>;
/**
 ...
 * @private
 */
declare function decoderStartBeams(self: Object, inputTokenIds: Tensor, generation_config: Object, numOutputTokens: number, inputs_attention_mask?: Tensor): Object[];
/**
 ...
 * @private
 */
declare function seq2seqStartBeams(self: PreTrainedModel, inputTokenIds: Tensor, generation_config: Object, numOutputTokens: number): Object[];
/**
 * Update a beam with a new token ID.
 * @param {Object} beam The beam to update.
 * @param {number} newTokenId The new token ID to add to the beam's output.
 * @private
 */
declare function decoderUpdatebeam(beam: Object, newTokenId: number): void;
/**
 ...
 * @private
 */
declare function encoderForward(self: Object, model_inputs: Object): Promise<Object>;
