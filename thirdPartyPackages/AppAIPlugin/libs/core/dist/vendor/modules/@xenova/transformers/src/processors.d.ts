...
export class ImageFeatureExtractor extends FeatureExtractor {
    ...
    pad_image(pixelData: Float32Array, imgDims: number[], padSize: {
        ...
        mode?: "constant" | "symmetric" | undefined;
        center?: boolean | undefined;
        constant_values?: number | undefined;
    }): [Float32Array, number[]];
    /**
     ...
     */
    preprocess(image: RawImage, { do_normalize, do_pad, do_convert_rgb, do_convert_grayscale, }?: Object): Promise<{
        /**
...
export class OwlViTFeatureExtractor extends ImageFeatureExtractor {
    ...
    post_process_object_detection(outputs: {
        logits: Tensor;
        pred_boxes: Tensor;
    }, threshold?: number, target_sizes?: number[][], is_zero_shot?: boolean): Object[];
}
