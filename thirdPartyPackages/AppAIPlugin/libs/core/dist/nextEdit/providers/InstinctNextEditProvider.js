...
import { contextSnippetsBlock, currentFileContentBlock, editHistoryBlock, } from "../templating/instinct.js";
...
export class InstinctProvider extends BaseNextEditModelProvider {
    ...
    async generatePrompts(context) {
        ...
        const templateVars = {
            ...
            currentFileContent: currentFileContentBlock(promptCtx.currentFileContent, promptCtx.windowStart, promptCtx.windowEnd, promptCtx.editableRegionStartLine, promptCtx.editableRegionEndLine, context.helper.pos),
