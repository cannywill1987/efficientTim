...
import { contextSnippetsBlock, currentFileContentBlock, editHistoryBlock, } from "./instinct";
...
line 4`;
        const windowStart = 0;
        const windowEnd = 4;
        const cursorPosition = { line: 2, character: 4 };
        const editableRegionStartLine = 1;
        const editableRegionEndLine = 3;
        const result = currentFileContentBlock(content, windowStart, windowEnd, editableRegionStartLine, editableRegionEndLine, cursorPosition);
...
line 2`;
        const windowStart = 0;
        const windowEnd = 2;
        const cursorPosition = { line: 1, character: 6 }; // end of "line 1"
        const editableRegionStartLine = 0;
        const editableRegionEndLine = 2;
        const result = currentFileContentBlock(content, windowStart, windowEnd, editableRegionStartLine, editableRegionEndLine, cursorPosition);
        const expected = `<|editable_region_start|>
...
line 2`;
        const windowStart = 0;
        const windowEnd = 2;
        const cursorPosition = { line: 1, character: 2 };
        const editableRegionStartLine = 1;
...
line 1`;
        const windowStart = 0;
        const windowEnd = 1;
        const cursorPosition = { line: 10, character: 0 }; // out of bounds
        const editableRegionStartLine = 0;
        const editableRegionEndLine = 1;
        const result = currentFileContentBlock(content, windowStart, windowEnd, editableRegionStartLine, editableRegionEndLine, cursorPosition);
        const expected = `<|editable_region_start|>
...
line 4`;
        const windowStart = 1;
        const windowEnd = 3;
        const cursorPosition = { line: 2, character: 2 };
