...
import { MERCURY_CODE_TO_EDIT_CLOSE, MERCURY_CODE_TO_EDIT_OPEN, MERCURY_CURSOR, MERCURY_RECENTLY_VIEWED_CODE_SNIPPET_CLOSE, MERCURY_RECENTLY_VIEWED_CODE_SNIPPET_OPEN, } from "../constants";
import { currentFileContentBlock, editHistoryBlock, recentlyViewedCodeSnippetsBlock, } from "./mercuryCoderNextEdit";
describe("mercuryCoderNextEdit", () => {
    describe("recentlyViewedCodeSnippetsBlock", () => {
        it("should format a list of code snippets correctly", () => {
            ...
            const expected = `${MERCURY_RECENTLY_VIEWED_CODE_SNIPPET_OPEN}\n` +
    ...
    describe("currentFileContentBlock", () => {
        it("should correctly format current file content with editable region and cursor", () => {
            ...
            const cursorPosition = { line: 2, character: 3 };
            const result = currentFileContentBlock(fileContent, editableRegionStartLine, editableRegionEndLine, cursorPosition);
        ...
        it("should handle cursor at the beginning of a line", () => {
            ...
            const cursorPosition = { line: 1, character: 0 };
            const result = currentFileContentBlock(fileContent, editableRegionStartLine, editableRegionEndLine, cursorPosition);
        ...
        it("should handle cursor at the end of a line", () => {
            ...
            const editableRegionStartLine = 0;
            const editableRegionEndLine = 2;
            const cursorPosition = { line: 1, character: 6 };
            const result = currentFileContentBlock(fileContent, editableRegionStartLine, editableRegionEndLine, cursorPosition);
