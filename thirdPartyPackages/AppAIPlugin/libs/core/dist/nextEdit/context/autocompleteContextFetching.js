 ...
 */
export const getAutocompleteContext = async (filepath, pos, ide, configHandler, getDefinitionsFromLsp = async () => [], recentlyEditedRanges, recentlyVisitedRanges, maxPromptTokens, manuallyPassFileContents, autocompleteModel) => {
