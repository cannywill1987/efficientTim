...
export const MODEL_WINDOW_SIZES = {
    "mercury-coder": {
        topMargin: 0,
        bottomMargin: 5,
...
export const INSTINCT_USER_PROMPT_PREFIX = "Reference the user excerpt, user edits, and the snippets to understand the developer's intent. Update the editable region of the user excerpt by predicting and completing the changes they would have made next. This may be a deletion, addition, or modification of code.";
