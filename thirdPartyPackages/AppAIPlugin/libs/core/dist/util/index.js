export function removeQuotesAndEscapes(input) {
...
export function dedentAndGetCommonWhitespace(s) {
    const lines = s.split("\n");
...
export function getMarkdownLanguageTagForFile(filepath) {
    const extToLangMap = {
        py: "python",
        js: "javascript",
        jsx: "jsx",
...
export function copyOf(obj) {
    if (obj === null || obj === undefined) {
        return obj;
    }
    return JSON.parse(JSON.stringify(obj));
}
export function deduplicateArray(array, equal) {
    const result = [];
 ...
 */
export function removeCodeBlocksAndTrim(text) {
...
export function splitCamelCaseAndNonAlphaNumeric(value) {
    return value
