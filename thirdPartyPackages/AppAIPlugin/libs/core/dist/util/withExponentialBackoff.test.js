...
import { withExponentialBackoff, RETRY_AFTER_HEADER, } from "./withExponentialBackoff";
describe.skip("withExponentialBackoff", () => {
    ...
    it("should throw error after maxTries reached", async () => {
        ...
        // Act & Assert
        await expect(withExponentialBackoff(apiCall, maxTries, initialDelaySeconds)).rejects.toThrow("Failed to make API call after max tries");
