...
import { capitalizeFirstLetter, escapeForSVG, kebabOfStr, kebabOfThemeStr, replaceEscapedCharacters, } from "./text";
...
describe("replaceEscapedCharacters", () => {
    ...
    it("should handle multiple escaped characters", () => {
        expect(replaceEscapedCharacters("Line1\\nLine2\\tTabbed\\\\Backslash")).toBe("Line1\nLine2\tTabbed\\Backslash");
    });
...
describe("kebabOfStr", () => {
    ...
    it("should convert mixed formats", () => {
        ...
        expect(kebabOfStr("PascalCase_Snake SPACE")).toBe("pascal-case-snake-space");
    });
...
describe("kebabOfThemeStr", () => {
    ...
    it("should convert underscores to hyphens", () => {
        ...
        expect(kebabOfThemeStr("multiple___underscores")).toBe("multiple-underscores");
    });
