...
*/
export async function resolveRelativePathInDir(path, ide, dirUriCandidates) {
...
*/
export async function inferResolvedUriFromRelativePath(_relativePath, ide, dirCandidates) {
