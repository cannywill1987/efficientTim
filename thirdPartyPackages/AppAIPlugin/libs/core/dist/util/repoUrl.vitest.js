...
describe("normalizeRepoUrl", () => {
    ...
    describe("SSH protocol conversion", () => {
        ...
        it("should convert ssh:// protocol without .git suffix", () => {
            expect(normalizeRepoUrl("ssh://git@github.com/owner/repo")).toBe("https://github.com/owner/repo");
        });
    });
    describe("shorthand format conversion", () => {
        ...
        it("should handle shorthand with hyphens and underscores", () => {
            expect(normalizeRepoUrl("owner-name/repo_name")).toBe("https://github.com/owner-name/repo_name");
        });
    });
    ...
    describe("case normalization", () => {
        ...
        it("should handle mixed case in shorthand format", () => {
            expect(normalizeRepoUrl("ContinueDev/Continue")).toBe("https://github.com/continuedev/continue");
        });
    });
    ...
    describe("edge cases", () => {
        ...
        it("should not convert non-GitHub SSH URLs to GitHub", () => {
            ...
            expect(normalizeRepoUrl("ssh://git@gitlab.com/owner/repo.git")).toBe("ssh://git@gitlab.com/owner/repo");
        });
        it("should handle URLs with port numbers", () => {
            expect(normalizeRepoUrl("https://github.com:443/owner/repo")).toBe("https://github.com:443/owner/repo");
        });
        it("should handle complex repository names", () => {
            expect(normalizeRepoUrl("owner/repo-with-dashes-123")).toBe("https://github.com/owner/repo-with-dashes-123");
        });
        it("should normalize shorthand with query parameters containing ://", () => {
            ...
            expect(normalizeRepoUrl("owner/repo?redirect=https://example.com")).toBe("https://github.com/owner/repo?redirect=https://example.com");
        });
        it("should normalize shorthand with fragment containing ://", () => {
            expect(normalizeRepoUrl("owner/repo#section=https://example.com")).toBe("https://github.com/owner/repo#section=https://example.com");
        });
    });
    describe("real-world examples", () => {
        it("should normalize Continue's repository from SSH", () => {
            expect(normalizeRepoUrl("git@github.com:continuedev/continue.git")).toBe("https://github.com/continuedev/continue");
        });
        it("should normalize Continue's repository from shorthand", () => {
            expect(normalizeRepoUrl("continuedev/continue")).toBe("https://github.com/continuedev/continue");
        });
        it("should normalize Continue's repository from HTTPS", () => {
            expect(normalizeRepoUrl("https://github.com/continuedev/continue.git")).toBe("https://github.com/continuedev/continue");
        });
