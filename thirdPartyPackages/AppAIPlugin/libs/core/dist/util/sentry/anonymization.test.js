import { anonymizeFilePath, anonymizeSentryEvent, anonymizeStackTrace, anonymizeUserInfo, } from "./anonymization";
describe("Sentry Anonymization Utilities", () => {
    describe("anonymizeFilePath", () => {
        it("should anonymize absolute paths but preserve node_modules package names", () => {
            ...
            expect(anonymizeFilePath("C:\\Users\\john\\Documents\\code.go")).toBe("<file>");
            expect(anonymizeFilePath("/project/node_modules/react/index.js")).toBe("node_modules/react/<file>");
        });
        ...
        it("should handle empty or undefined paths", () => {
            ...
            expect(anonymizeFilePath(undefined)).toBe(undefined);
            expect(anonymizeFilePath(null)).toBe(null);
        });
    });
    describe("anonymizeStackTrace", () => {
        ...
        it("should handle non-array input", () => {
            expect(anonymizeStackTrace(null)).toBe(null);
            expect(anonymizeStackTrace(undefined)).toBe(undefined);
            expect(anonymizeStackTrace("not-array")).toBe("not-array");
        });
    });
