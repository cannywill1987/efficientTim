 ...
 */
export function validateAndSanitizeRegex(query) {
 ...
 */
export function escapeLiteralForRegex(literal) {
 ...
 */
export function looksLikeLiteralSearch(query) {
 ...
 */
export function prepareQueryForRipgrep(query) {
