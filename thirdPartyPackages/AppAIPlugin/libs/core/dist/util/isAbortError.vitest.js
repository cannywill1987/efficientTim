...
describe("isAbortError", () => {
    ...
    it.skipIf(!hasDOMException)("returns true for DOMException with AbortError name", () => {
    ...
    it.skipIf(!hasDOMException)("returns false for DOMException with non-AbortError name", () => {
