 ...
 */
export function sanitizeMessageForTTS(message) {
    ...
    static async read(message) {
        ...
        switch (TTS.os) {
            ...
            case "win32":
                ...
                TTS.handle = exec(`powershell -Command "Add-Type -AssemblyName System.Speech; (New-Object System.Speech.Synthesis.SpeechSynthesizer).Speak('${message.replace(/'/g, "''")}')"`);
                break;
            case "linux":
