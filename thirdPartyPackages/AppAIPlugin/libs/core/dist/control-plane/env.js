...
import { getLocalEnvironmentDotFilePath, getStagingEnvironmentDotFilePath, } from "../util/paths";
...
export async function getControlPlaneEnv(ideSettingsPromise) {
    const ideSettings = await ideSettingsPromise;
    return getControlPlaneEnvSync(ideSettings.continueTestEnvironment);
}
export function getControlPlaneEnvSync(ideTestEnvironment) {
    // MDM override
...
export async function useHub(ideSettingsPromise) {
    const ideSettings = await ideSettingsPromise;
