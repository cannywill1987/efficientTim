...
import { walkDir, walkDirAsync, walkDirCache, walkDirs, } from "../indexing/walkDir";
import { testIde } from "../test/fixtures";
import { addToTestDir, setUpTestDir, tearDownTestDir, TEST_DIR_PATH, } from "../test/testDir";
describe("walkDir functions", () => {
    ...
    describe("walkDir", () => {
        it("should walk a simple directory structure", async () => {
            ...
            const files = await walkDir((await testIde.getWorkspaceDirs())[0], testIde);
        ...
        it("should respect .gitignore", async () => {
            ...
            const files = await walkDir((await testIde.getWorkspaceDirs())[0], testIde);
            expect(files).toEqual(expect.not.arrayContaining([
        ...
        it("should handle include option", async () => {
            ...
            const dirs = await walkDir((await testIde.getWorkspaceDirs())[0], testIde, {
                include: "dirs",
            });
    ...
    describe("walkDirAsync", () => {
        it("should yield files asynchronously", async () => {
            ...
            const files = [];
            for await (const file of walkDirAsync((await testIde.getWorkspaceDirs())[0], testIde)) {
                files.push(file);
            }
            expect(files.sort()).toEqual([
                expect.stringContaining("src/file1.ts"),
