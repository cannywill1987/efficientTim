...
import { TEST_DIR, addToTestDir, setUpTestDir, tearDownTestDir, } from "../test/testDir";
...
describe("shouldIgnore", () => {
    ...
    test("should handle multiple levels of directories with some files ignored", async () => {
        ...
        const ignoredResult = await shouldIgnore(TEST_DIR + "/nested/dir1/ignored.txt", testIde, [TEST_DIR]);
        expect(ignoredResult).toBe(true);
        const keptResult = await shouldIgnore(TEST_DIR + "/nested/dir2/kept.txt", testIde, [TEST_DIR]);
