...
export class SqliteDb {
  ...
  `);
    ...
    static indexSqlitePath = getIndexSqlitePath();
    static async get() {
...
export async function getComputeDeleteAddRemove(tag, currentFiles, readFile, repoName) {
...
export class GlobalCacheCodeBaseIndex {
    db;
...
export function truncateToLastNBytes(input, maxBytes) {
    let bytes = 0;
    let startIndex = 0;
...
export function truncateSqliteLikePattern(input, safety = 100) {
