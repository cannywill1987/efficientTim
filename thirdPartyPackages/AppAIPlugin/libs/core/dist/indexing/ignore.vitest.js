...
import { DEFAULT_SECURITY_IGNORE_DIRS, DEFAULT_SECURITY_IGNORE_FILETYPES, defaultFileAndFolderSecurityIgnores, isSecurityConcern, } from "./ignore";
describe("isSecurityConcern", () => {
    ...
    describe("Path variations", () => {
        ...
        it("should handle nested paths", () => {
            ...
            expect(isSecurityConcern("src/main/resources/application.secret")).toBe(true);
