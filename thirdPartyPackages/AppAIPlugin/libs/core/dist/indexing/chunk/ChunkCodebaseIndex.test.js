...
import { mockFileContents, mockFilename, mockPathAndCacheKey, testContinueServerClient, updateIndexAndAwaitGenerator, } from "../test/indexing";
...
describe("ChunkCodebaseIndex", () => {
    ...
    beforeAll(async () => {
        index = new ChunkCodebaseIndex(testIde.readFile.bind(testIde), testContinueServerClient, 1000);
