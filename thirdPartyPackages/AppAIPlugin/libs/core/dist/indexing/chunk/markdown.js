...
export async function* markdownChunker(content, maxChunkSize, hLevel) {
    ...
    for (const section of sections) {
        for await (const chunk of markdownChunker(section.content, maxChunkSize - (section.header ? countTokens(section.header) : 0), hLevel + 1)) {
            yield {
