 ...
 */
export function shouldStopAtMarkdownBlock(stateTracker, currentIndex) {
    return stateTracker.shouldStopAtPosition(currentIndex);
}
/**
 * Processes block nesting logic and returns updated state.
 */
export function processBlockNesting(line, seenFirstFence, shouldRemoveLineBeforeStart) {
 ...
 */
export async function* stopAtLinesWithMarkdownSupport(lines, filename) {
