...
} = require("../scripts/install-copy-nodemodule");
...
(async () => {
  ...
  const filesToCopy = [
    "../libs/core/vendor/tree-sitter.wasm",
    "../libs/core/llm/llamaTokenizerWorkerPool.mjs",
    "../libs/core/llm/llamaTokenizer.mjs",
    "../libs/core/llm/tiktokenWorkerPool.mjs",
  ];
  ...
  fs.cpSync(
    "../libs/core/node_modules/jsdom/lib/jsdom/living/xhr/xhr-sync-worker.js",
