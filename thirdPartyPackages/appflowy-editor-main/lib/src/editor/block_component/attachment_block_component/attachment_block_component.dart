...
Node attachmentNode({
  ...
  return Node(
    ...
    attributes: {
      AttachmentBlockKeys.url: url,
      AttachmentBlockKeys.align: align,
      AttachmentBlockKeys.height: height,
      AttachmentBlockKeys.width: width,
    },
  );
}

typedef AttachmentBlockComponentMenuBuilder = Widget Function(
  Node node,
  ImageBlockComponentWidgetState state,
);

class AttachmentBlockComponentBuilder extends BlockComponentBuilder {
  AttachmentBlockComponentBuilder({
    super.configuration,
    this.showMenu = false,
    this.menuBuilder,
  });
  ...
  ///
  final AttachmentBlockComponentMenuBuilder? menuBuilder;
...
class ImageBlockComponentWidgetState extends State<AttachmentBlockComponentWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final src = attributes[AttachmentBlockKeys.url];

    final alignment = AlignmentExtension.fromString(
      attributes[AttachmentBlockKeys.align] ?? 'center',
    );
    final width = attributes[AttachmentBlockKeys.width]?.toDouble() ??
        MediaQuery.of(context).size.width;
    final height = attributes[AttachmentBlockKeys.height]?.toDouble();
