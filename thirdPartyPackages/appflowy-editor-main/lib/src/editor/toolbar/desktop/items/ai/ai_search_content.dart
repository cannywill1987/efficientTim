...
class AISearchContentWidget extends StatefulWidget {
  Function? onSubmit;
  String? title;
  String? prompt;
  String? placeholder;

  AISearchContentWidget({this.onSubmit, this.prompt, this.title, this.placeholder});

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return AISearchContentWidgetState();
  }
}

class AISearchContentWidgetState extends State<AISearchContentWidget> {
