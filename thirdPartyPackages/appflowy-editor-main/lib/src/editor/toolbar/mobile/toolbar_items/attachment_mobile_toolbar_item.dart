...
final attachmentMobileToolbarItem = MobileToolbarItem.action(
  itemIconBuilder: (context, __, ___) => AFMobileIcon(
    afMobileIcons: AFMobileIcons.attachment,
    color: MobileToolbarTheme.of(context).iconColor,
  ),
  actionHandler: (_, editorState) {
    // same as the [handler] of [dividerMenuItem] in Desktop
    final container = Overlay.of(context as BuildContext, rootOverlay: true);
